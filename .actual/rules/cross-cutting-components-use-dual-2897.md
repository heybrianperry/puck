# Establish Dual-Interface Pattern for Public API Contracts in React Components: Components Use Dual
...
- **R-DUAL-001** MAY: Components MAY use the dual-interface pattern selectively for components with external consumers, while internal-only components MAY use single interfaces.
...
# Find components using public contracts
