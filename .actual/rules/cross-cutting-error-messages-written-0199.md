# Use console.error for CLI Error Reporting in Node.js Applications: Error Messages Written
...
- **R-CLI-ERR-001** MUST: Error messages MUST be written to stderr (via console.error) to enable proper stream separation from stdout.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of these rules. All error reporting in scope MUST use console.error for proper stderr stream separation.
</enforcement>