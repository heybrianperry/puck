...
1. MUST_NOT: Application code MUST NOT directly use localStorage values without parsing and validation in security-sensitive contexts

## Policy Block

- MUST_NOT Application code MUST NOT directly use localStorage values without parsing and validation in security-sensitive contexts
