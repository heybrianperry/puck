...
1. MAY: Use compound keys (zoneCompound) for Map entries when tracking state across multiple dimensions such as zone and virtualizer pairings

## Policy Block

- MAY Use compound keys (zoneCompound) for Map entries when tracking state across multiple dimensions such as zone and virtualizer pairings
