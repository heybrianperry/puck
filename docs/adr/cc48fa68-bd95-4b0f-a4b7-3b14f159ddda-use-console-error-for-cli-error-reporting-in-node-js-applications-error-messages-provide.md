...
1. SHOULD: Error messages SHOULD provide actionable guidance (e.g., 'Please provide a name for your app' rather than generic error codes)

## Policy Block

- SHOULD Error messages SHOULD provide actionable guidance (e.g., 'Please provide a name for your app' rather than generic error codes)
