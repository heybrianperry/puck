# Adopt Catch-All Route Patterns for Dynamic Content Management Systems: Catch Routes Isolated
...
1. SHOULD: Catch-all routes SHOULD be isolated in dedicated route segments to prevent conflicts with static application routes

## Policy Block

- SHOULD Catch-all routes SHOULD be isolated in dedicated route segments to prevent conflicts with static application routes
