...
1. SHOULD: Utility functions for ID generation and common operations SHOULD be imported from @/core/lib rather than duplicated

## Policy Block

- SHOULD Utility functions for ID generation and common operations SHOULD be imported from @/core/lib rather than duplicated
