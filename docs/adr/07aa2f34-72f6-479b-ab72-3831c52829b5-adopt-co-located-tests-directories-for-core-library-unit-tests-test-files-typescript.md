# Adopt Co-located __tests__ Directories for Core Library Unit Tests: Test Files Typescript
...
1. MUST: Test files for TypeScript React components and utilities MUST use the .spec.tsx file extension

## Policy Block

- MUST Test files for TypeScript React components and utilities MUST use the .spec.tsx file extension
