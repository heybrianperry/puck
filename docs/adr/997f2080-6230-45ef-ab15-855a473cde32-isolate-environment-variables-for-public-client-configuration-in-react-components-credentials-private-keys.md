...
1. MUST: API credentials, private keys, and sensitive secrets MUST NOT be prefixed with NEXT_PUBLIC_ or accessed from client components

## Policy Block

- MUST API credentials, private keys, and sensitive secrets MUST NOT be prefixed with NEXT_PUBLIC_ or accessed from client components
