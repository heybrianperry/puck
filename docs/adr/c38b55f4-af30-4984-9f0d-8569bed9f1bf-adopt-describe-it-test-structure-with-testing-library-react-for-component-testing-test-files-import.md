...
1. MAY: Test files MAY import @testing-library/jest-dom for enhanced DOM assertion matchers

## Policy Block

- MAY Test files MAY import @testing-library/jest-dom for enhanced DOM assertion matchers
