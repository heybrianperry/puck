...
1. MUST: Tree-walking functions MUST provide context information (parentId, propName) to callbacks to enable location-aware transformations

## Policy Block

- MUST Tree-walking functions MUST provide context information (parentId, propName) to callbacks to enable location-aware transformations
