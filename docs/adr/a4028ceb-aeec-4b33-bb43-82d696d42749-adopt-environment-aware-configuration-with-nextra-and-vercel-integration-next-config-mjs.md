...
1. MUST: The next.config.mjs file MUST declare Nextra as a core dependency via package.json reference

## Policy Block

- MUST The next.config.mjs file MUST declare Nextra as a core dependency via package.json reference
