...
1. MAY: Components MAY supplement console logging with user-facing error states or fallback UI

## Policy Block

- MAY Components MAY supplement console logging with user-facing error states or fallback UI
