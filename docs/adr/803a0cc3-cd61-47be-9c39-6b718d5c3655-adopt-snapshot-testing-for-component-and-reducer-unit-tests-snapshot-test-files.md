# Adopt Snapshot Testing for Component and Reducer Unit Tests: Snapshot Test Files
...
1. MUST: Snapshot test files MUST use the .spec.ts or .spec.tsx extension to ensure CI/CD pipeline recognition

## Policy Block

- MUST Snapshot test files MUST use the .spec.ts or .spec.tsx extension to ensure CI/CD pipeline recognition
