# Adopt Modular Library Architecture with Core Package Pattern: Core Reusable Functionality
...
1. MUST: Core reusable functionality MUST be organized within a dedicated packages/core directory structure with separate lib and components subdirectories

## Policy Block

- MUST Core reusable functionality MUST be organized within a dedicated packages/core directory structure with separate lib and components subdirectories
