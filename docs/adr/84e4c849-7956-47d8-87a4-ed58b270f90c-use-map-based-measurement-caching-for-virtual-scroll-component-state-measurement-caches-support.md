...
1. MUST: Measurement caches MUST support get, set, and delete operations for component height data and measurement references

## Policy Block

- MUST Measurement caches MUST support get, set, and delete operations for component height data and measurement references
