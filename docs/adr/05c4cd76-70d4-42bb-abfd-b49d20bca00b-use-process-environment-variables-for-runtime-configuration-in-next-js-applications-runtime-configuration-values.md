...
1. MUST: Runtime configuration values MUST be sourced from process.env in Next.js configuration files

## Policy Block

- MUST Runtime configuration values MUST be sourced from process.env in Next.js configuration files
