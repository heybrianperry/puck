...
1. MUST: Virtual scroll components MUST use Map data structures to cache item measurements keyed by component ID

## Policy Block

- MUST Virtual scroll components MUST use Map data structures to cache item measurements keyed by component ID
