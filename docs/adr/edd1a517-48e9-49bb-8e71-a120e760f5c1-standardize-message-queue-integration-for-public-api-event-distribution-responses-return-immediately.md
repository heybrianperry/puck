# Standardize Message Queue Integration for Public API Event Distribution: Responses Return Immediately
...
1. SHOULD: API responses SHOULD return immediately after successful event publication without waiting for downstream processing

## Policy Block

- SHOULD API responses SHOULD return immediately after successful event publication without waiting for downstream processing
