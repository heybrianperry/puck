...
1. SHOULD: Framework and third-party library imports SHOULD use bare module specifiers without path aliases

## Policy Block

- SHOULD Framework and third-party library imports SHOULD use bare module specifiers without path aliases
