# Adopt Snapshot Testing for Component and Reducer Unit Tests: Teams Supplement Snapshot
...
1. MAY: Teams MAY supplement snapshot tests with targeted assertion-based tests for critical business logic paths

## Policy Block

- MAY Teams MAY supplement snapshot tests with targeted assertion-based tests for critical business logic paths
