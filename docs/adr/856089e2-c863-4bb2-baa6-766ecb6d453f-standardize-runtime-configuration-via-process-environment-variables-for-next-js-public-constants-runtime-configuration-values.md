...
1. MUST: Runtime configuration values accessed in client-side components MUST be sourced from process.env with the NEXT_PUBLIC_ prefix

## Policy Block

- MUST Runtime configuration values accessed in client-side components MUST be sourced from process.env with the NEXT_PUBLIC_ prefix
