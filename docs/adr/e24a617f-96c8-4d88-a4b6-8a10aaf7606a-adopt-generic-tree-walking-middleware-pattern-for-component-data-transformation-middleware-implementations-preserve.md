...
1. SHOULD: Middleware implementations SHOULD preserve the original data structure shape while allowing selective transformation of nested content

## Policy Block

- SHOULD Middleware implementations SHOULD preserve the original data structure shape while allowing selective transformation of nested content
