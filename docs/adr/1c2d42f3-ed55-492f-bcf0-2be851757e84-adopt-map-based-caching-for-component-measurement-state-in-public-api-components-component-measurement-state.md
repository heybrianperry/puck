...
1. MUST: Component measurement state (heights, refs, handles) MUST be stored in Map instances using component identifiers as keys

## Policy Block

- MUST Component measurement state (heights, refs, handles) MUST be stored in Map instances using component identifiers as keys
