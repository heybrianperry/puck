...
1. MAY: Additional cache structures such as Set MAY be used for tracking indexes or identifiers that require uniqueness guarantees

## Policy Block

- MAY Additional cache structures such as Set MAY be used for tracking indexes or identifiers that require uniqueness guarantees
