...
1. MUST: API call failures MUST be logged using console.error with descriptive error messages including the error details

## Policy Block

- MUST API call failures MUST be logged using console.error with descriptive error messages including the error details
