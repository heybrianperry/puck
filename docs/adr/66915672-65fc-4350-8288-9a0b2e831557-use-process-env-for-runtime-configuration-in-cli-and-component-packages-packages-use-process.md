...
1. SHOULD: Packages SHOULD use process.env as the primary runtime configuration source rather than configuration files

## Policy Block

- SHOULD Packages SHOULD use process.env as the primary runtime configuration source rather than configuration files
