...
1. SHOULD: API client calls SHOULD be initiated within React useEffect hooks to ensure proper lifecycle management and avoid server-side execution conflicts

## Policy Block

- SHOULD API client calls SHOULD be initiated within React useEffect hooks to ensure proper lifecycle management and avoid server-side execution conflicts
