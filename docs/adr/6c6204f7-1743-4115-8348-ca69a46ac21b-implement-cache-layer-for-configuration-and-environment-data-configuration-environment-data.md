# Implement Cache Layer for Configuration and Environment Data: Configuration Environment Data
...
1. MUST: Configuration and environment data that is accessed multiple times within a request lifecycle MUST be cached in memory

## Policy Block

- MUST Configuration and environment data that is accessed multiple times within a request lifecycle MUST be cached in memory
