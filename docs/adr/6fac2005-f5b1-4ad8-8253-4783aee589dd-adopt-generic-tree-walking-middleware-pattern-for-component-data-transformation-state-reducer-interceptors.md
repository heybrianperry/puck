...
1. MUST: State reducer interceptors MUST wrap base reducers and provide hooks for recording state changes and executing onAction callbacks

## Policy Block

- MUST State reducer interceptors MUST wrap base reducers and provide hooks for recording state changes and executing onAction callbacks
