...
1. MUST: Component lifecycle managers MUST use Map data structures keyed by component ID for storing instance-specific resources such as measurement callbacks, virtualizer handles, or cached dimensions

## Policy Block

- MUST Component lifecycle managers MUST use Map data structures keyed by component ID for storing instance-specific resources such as measurement callbacks, virtualizer handles, or cached dimensions
