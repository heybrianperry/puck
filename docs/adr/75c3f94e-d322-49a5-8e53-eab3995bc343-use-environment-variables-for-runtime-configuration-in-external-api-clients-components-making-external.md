...
1. MUST: Components making external fetch calls MUST construct full URLs by combining environment-sourced base URLs with API paths

## Policy Block

- MUST Components making external fetch calls MUST construct full URLs by combining environment-sourced base URLs with API paths
