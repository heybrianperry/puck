# Adopt Client-Side Rendering Pattern for External API Integration in Dynamic Content Editors: External Integration Components
...
1. MUST: External API integration components that provide interactive editing capabilities MUST be implemented as client-side rendered components using the 'use client' directive in Next.js or equivalent client-side markers in other frameworks

## Policy Block

- MUST External API integration components that provide interactive editing capabilities MUST be implemented as client-side rendered components using the 'use client' directive in Next.js or equivalent client-side markers in other frameworks
