# Adopt Async Data Resolution with Concurrent Promise Handling for Logging Operations: Multiple Concurrent Data
...
1. MUST: Multiple concurrent data resolution operations MUST be handled using Promise.all() or equivalent concurrent Promise handling mechanisms

## Policy Block

- MUST Multiple concurrent data resolution operations MUST be handled using Promise.all() or equivalent concurrent Promise handling mechanisms
