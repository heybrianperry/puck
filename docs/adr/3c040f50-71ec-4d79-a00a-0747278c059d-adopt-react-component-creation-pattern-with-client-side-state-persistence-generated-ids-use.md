...
1. SHOULD: Generated IDs SHOULD use the centralized generate-id utility from @/core/lib to ensure uniqueness

## Policy Block

- SHOULD Generated IDs SHOULD use the centralized generate-id utility from @/core/lib to ensure uniqueness
