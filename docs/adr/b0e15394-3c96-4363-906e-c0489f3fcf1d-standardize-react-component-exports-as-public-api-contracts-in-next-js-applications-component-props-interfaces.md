...
1. MUST: Component Props interfaces MUST follow the naming convention {ComponentName}Props

## Policy Block

- MUST Component Props interfaces MUST follow the naming convention {ComponentName}Props
