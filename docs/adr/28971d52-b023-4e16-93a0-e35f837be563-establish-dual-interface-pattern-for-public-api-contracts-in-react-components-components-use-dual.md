...
1. MAY: Components MAY use the dual-interface pattern selectively for components with external consumers, while internal-only components MAY use single interfaces

## Policy Block

- MAY Components MAY use the dual-interface pattern selectively for components with external consumers, while internal-only components MAY use single interfaces
