...
1. SHOULD: Public configuration values SHOULD be documented in environment variable templates or README files

## Policy Block

- SHOULD Public configuration values SHOULD be documented in environment variable templates or README files
