...
1. SHOULD: Applications executing external processes via execSync or spawn SHOULD track child process handles and terminate them in signal handlers

## Policy Block

- SHOULD Applications executing external processes via execSync or spawn SHOULD track child process handles and terminate them in signal handlers
