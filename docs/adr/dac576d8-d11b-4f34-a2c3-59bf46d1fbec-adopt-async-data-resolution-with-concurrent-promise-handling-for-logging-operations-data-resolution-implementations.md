# Adopt Async Data Resolution with Concurrent Promise Handling for Logging Operations: Data Resolution Implementations
...
1. MAY: Data resolution implementations MAY use Promise.allSettled() when partial failure tolerance is required

## Policy Block

- MAY Data resolution implementations MAY use Promise.allSettled() when partial failure tolerance is required
