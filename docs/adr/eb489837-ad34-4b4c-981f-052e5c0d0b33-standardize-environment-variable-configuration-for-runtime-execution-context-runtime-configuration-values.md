# Standardize Environment Variable Configuration for Runtime Execution Context: Runtime Configuration Values
...
1. MUST: All runtime configuration values MUST be sourced from environment variables rather than hardcoded in application code

## Policy Block

- MUST All runtime configuration values MUST be sourced from environment variables rather than hardcoded in application code
