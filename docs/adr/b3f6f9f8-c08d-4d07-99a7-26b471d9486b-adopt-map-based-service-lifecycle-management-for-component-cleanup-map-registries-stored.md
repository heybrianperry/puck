...
1. SHOULD: Map registries SHOULD be stored in refs (useRef) or module-level variables to persist across renders without triggering re-renders

## Policy Block

- SHOULD Map registries SHOULD be stored in refs (useRef) or module-level variables to persist across renders without triggering re-renders
