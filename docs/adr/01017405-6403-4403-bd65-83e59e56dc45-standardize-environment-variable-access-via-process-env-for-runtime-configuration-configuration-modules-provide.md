# Standardize Environment Variable Access via process.env for Runtime Configuration: Configuration Modules Provide
...
1. SHOULD: Configuration modules SHOULD provide default values for non-critical environment variables to support local development

## Policy Block

- SHOULD Configuration modules SHOULD provide default values for non-critical environment variables to support local development
