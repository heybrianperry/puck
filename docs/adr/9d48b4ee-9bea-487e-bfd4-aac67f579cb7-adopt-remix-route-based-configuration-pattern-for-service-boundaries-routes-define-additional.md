# Adopt Remix Route-Based Configuration Pattern for Service Boundaries: Routes Define Additional
...
1. MAY: Routes MAY define additional service boundaries for specialized operations (e.g., AI services, external APIs) as needed for specific application variants

## Policy Block

- MAY Routes MAY define additional service boundaries for specialized operations (e.g., AI services, external APIs) as needed for specific application variants
