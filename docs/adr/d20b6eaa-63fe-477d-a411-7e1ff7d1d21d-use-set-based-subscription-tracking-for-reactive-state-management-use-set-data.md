...
1. MUST: Use Set data structures (e.g., nextPinnedIndexes.add(currentIndex)) for tracking collections of unique identifiers where membership testing and addition are primary operations

## Policy Block

- MUST Use Set data structures (e.g., nextPinnedIndexes.add(currentIndex)) for tracking collections of unique identifiers where membership testing and addition are primary operations
