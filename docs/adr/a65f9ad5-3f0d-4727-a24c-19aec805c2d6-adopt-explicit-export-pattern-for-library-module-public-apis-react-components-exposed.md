# Adopt Explicit Export Pattern for Library Module Public APIs: React Components Exposed
...
1. SHOULD: React components exposed as library modules SHOULD follow a consistent index.tsx export pattern for discoverability

## Policy Block

- SHOULD React components exposed as library modules SHOULD follow a consistent index.tsx export pattern for discoverability
