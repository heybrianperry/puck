...
1. MUST: CLI applications MUST use console.error for all user-facing error messages, validation failures, and exceptional conditions

## Policy Block

- MUST CLI applications MUST use console.error for all user-facing error messages, validation failures, and exceptional conditions
