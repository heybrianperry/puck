...
1. SHOULD: Internal API routes SHOULD follow the pattern /api/{resource} to maintain consistent endpoint structure

## Policy Block

- SHOULD Internal API routes SHOULD follow the pattern /api/{resource} to maintain consistent endpoint structure
