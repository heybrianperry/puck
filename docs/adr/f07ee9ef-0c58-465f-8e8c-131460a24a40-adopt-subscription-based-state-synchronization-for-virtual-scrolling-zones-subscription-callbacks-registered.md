...
1. SHOULD: Subscription callbacks SHOULD be registered within useEffect hooks to ensure proper lifecycle management and cleanup

## Policy Block

- SHOULD Subscription callbacks SHOULD be registered within useEffect hooks to ensure proper lifecycle management and cleanup
