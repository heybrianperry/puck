...
1. SHOULD: Callback functions SHOULD return the transformed content or null/void to indicate no change, allowing the middleware to preserve original values when appropriate

## Policy Block

- SHOULD Callback functions SHOULD return the transformed content or null/void to indicate no change, allowing the middleware to preserve original values when appropriate
