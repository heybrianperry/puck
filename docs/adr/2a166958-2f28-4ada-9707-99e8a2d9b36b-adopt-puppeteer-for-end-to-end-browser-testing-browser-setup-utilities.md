...
1. MUST: Browser setup utilities MUST expose configuration options for headless mode and other launch parameters

## Policy Block

- MUST Browser setup utilities MUST expose configuration options for headless mode and other launch parameters
