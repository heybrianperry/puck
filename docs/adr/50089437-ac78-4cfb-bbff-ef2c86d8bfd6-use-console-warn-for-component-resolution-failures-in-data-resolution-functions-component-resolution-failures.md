...
1. MUST: Component resolution failures in data resolution functions MUST log warnings using console.warn

## Policy Block

- MUST Component resolution failures in data resolution functions MUST log warnings using console.warn
