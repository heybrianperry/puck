...
1. SHOULD: Environment variable access SHOULD occur in next.config.mjs or equivalent configuration entry points

## Policy Block

- SHOULD Environment variable access SHOULD occur in next.config.mjs or equivalent configuration entry points
