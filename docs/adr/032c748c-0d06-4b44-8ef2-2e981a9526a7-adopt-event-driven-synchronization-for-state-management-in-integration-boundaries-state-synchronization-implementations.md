# Adopt Event-Driven Synchronization for State Management in Integration Boundaries: State Synchronization Implementations
...
1. MUST: State synchronization implementations MUST handle asynchronous updates and provide mechanisms to reconcile state differences

## Policy Block

- MUST State synchronization implementations MUST handle asynchronous updates and provide mechanisms to reconcile state differences
