...
1. SHOULD: E2E tests SHOULD handle iframe boundary transformations when validating coordinate-based APIs like getBox

## Policy Block

- SHOULD E2E tests SHOULD handle iframe boundary transformations when validating coordinate-based APIs like getBox
