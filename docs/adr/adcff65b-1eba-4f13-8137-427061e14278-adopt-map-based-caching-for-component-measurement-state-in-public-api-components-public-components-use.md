...
1. SHOULD: Public API components SHOULD use URLSearchParams.get() for retrieving configuration parameters from query strings in client-side contexts

## Policy Block

- SHOULD Public API components SHOULD use URLSearchParams.get() for retrieving configuration parameters from query strings in client-side contexts
