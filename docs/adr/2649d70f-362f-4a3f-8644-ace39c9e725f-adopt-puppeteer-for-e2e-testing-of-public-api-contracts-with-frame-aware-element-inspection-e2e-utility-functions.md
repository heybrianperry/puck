...
1. SHOULD: E2E utility functions SHOULD be organized in scripts/e2e/utils/ directory

## Policy Block

- SHOULD E2E utility functions SHOULD be organized in scripts/e2e/utils/ directory
