...
1. SHOULD: URL query parameters SHOULD be cached using URLSearchParams.get() for runtime configuration decisions

## Policy Block

- SHOULD URL query parameters SHOULD be cached using URLSearchParams.get() for runtime configuration decisions
