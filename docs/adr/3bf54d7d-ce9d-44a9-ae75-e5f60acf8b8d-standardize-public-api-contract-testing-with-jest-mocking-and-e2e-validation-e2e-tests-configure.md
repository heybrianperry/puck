...
1. MAY: E2E tests MAY configure puppeteer with headless mode options to support both CI and local debugging workflows

## Policy Block

- MAY E2E tests MAY configure puppeteer with headless mode options to support both CI and local debugging workflows
