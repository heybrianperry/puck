# Adopt TypeScript Configuration Export Pattern for Public API Packages: Route Handlers Public
...
1. MUST: API route handlers and public endpoints MUST follow consistent naming conventions (e.g., api.*.tsx, routes/api/*) to clearly identify external interfaces

## Policy Block

- MUST API route handlers and public endpoints MUST follow consistent naming conventions (e.g., api.*.tsx, routes/api/*) to clearly identify external interfaces
