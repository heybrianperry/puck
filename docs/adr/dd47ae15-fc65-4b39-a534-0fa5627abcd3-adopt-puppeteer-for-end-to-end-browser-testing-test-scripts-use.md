...
1. MAY: Test scripts MAY use asciichart or similar libraries for visualizing performance metrics during test runs

## Policy Block

- MAY Test scripts MAY use asciichart or similar libraries for visualizing performance metrics during test runs
