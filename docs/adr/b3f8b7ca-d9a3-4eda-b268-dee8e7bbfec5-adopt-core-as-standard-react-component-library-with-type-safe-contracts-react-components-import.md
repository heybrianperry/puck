...
1. MUST: All React components MUST import core functionality from @/core path alias rather than relative paths outside the local module

## Policy Block

- MUST All React components MUST import core functionality from @/core path alias rather than relative paths outside the local module
