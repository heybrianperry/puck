...
1. SHOULD: Components SHOULD clean up measurement cache entries using delete operations when items are removed from the virtual list

## Policy Block

- SHOULD Components SHOULD clean up measurement cache entries using delete operations when items are removed from the virtual list
