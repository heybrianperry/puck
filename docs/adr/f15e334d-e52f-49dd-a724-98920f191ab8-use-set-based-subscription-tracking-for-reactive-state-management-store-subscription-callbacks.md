...
1. SHOULD: Store subscription callbacks in ref objects (e.g., measureRefsRef.current) to avoid stale closures in React hooks

## Policy Block

- SHOULD Store subscription callbacks in ref objects (e.g., measureRefsRef.current) to avoid stale closures in React hooks
