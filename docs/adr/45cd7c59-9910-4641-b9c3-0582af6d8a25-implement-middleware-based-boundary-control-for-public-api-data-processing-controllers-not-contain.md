# Implement Middleware-Based Boundary Control for Public API Data Processing: Controllers Not Contain
...
1. MUST_NOT: API controllers MUST NOT contain direct data transformation logic; all transformations MUST be delegated to middleware

## Policy Block

- MUST_NOT API controllers MUST NOT contain direct data transformation logic; all transformations MUST be delegated to middleware
