# Standardize Jest Testing Framework with React Testing Library for Component Tests: Test Files Use
...
1. MUST: All test files MUST use Jest as the testing framework with .spec.tsx or .spec.ts extensions

## Policy Block

- MUST All test files MUST use Jest as the testing framework with .spec.tsx or .spec.ts extensions
