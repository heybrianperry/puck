...
1. MUST: Map-based registries MUST be accessed via .get(componentId), .set(componentId, value), and .delete(componentId) methods to maintain consistent lifecycle semantics

## Policy Block

- MUST Map-based registries MUST be accessed via .get(componentId), .set(componentId, value), and .delete(componentId) methods to maintain consistent lifecycle semantics
