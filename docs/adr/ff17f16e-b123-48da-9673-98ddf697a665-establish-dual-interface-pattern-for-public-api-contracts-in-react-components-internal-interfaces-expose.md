...
1. SHOULD: Internal interfaces SHOULD expose implementation details necessary for testing, composition, and internal tooling while public interfaces SHOULD expose only the stable consumer-facing API

## Policy Block

- SHOULD Internal interfaces SHOULD expose implementation details necessary for testing, composition, and internal tooling while public interfaces SHOULD expose only the stable consumer-facing API
