...
1. MUST: Data resolution functions MUST log component lookup failures using console.warn when a component cannot be found by ID or selector

## Policy Block

- MUST Data resolution functions MUST log component lookup failures using console.warn when a component cannot be found by ID or selector
