# Standardize Logging and Observability Configuration in Runtime Environments: Components Implement Environment
...
1. MAY: Components MAY implement environment-specific log levels (verbose in development, error-only in production)

## Policy Block

- MAY Components MAY implement environment-specific log levels (verbose in development, error-only in production)
