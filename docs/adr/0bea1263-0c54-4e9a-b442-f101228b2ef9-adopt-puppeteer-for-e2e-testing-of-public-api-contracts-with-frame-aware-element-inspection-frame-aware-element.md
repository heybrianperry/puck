...
1. MUST: Frame-aware element queries MUST check both document.querySelector and frame.querySelector for target elements

## Policy Block

- MUST Frame-aware element queries MUST check both document.querySelector and frame.querySelector for target elements
