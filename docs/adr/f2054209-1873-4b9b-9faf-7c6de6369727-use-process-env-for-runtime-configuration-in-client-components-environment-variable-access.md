...
1. SHOULD: Environment variable access SHOULD occur at component initialization or within useEffect hooks to ensure values are available at runtime

## Policy Block

- SHOULD Environment variable access SHOULD occur at component initialization or within useEffect hooks to ensure values are available at runtime
