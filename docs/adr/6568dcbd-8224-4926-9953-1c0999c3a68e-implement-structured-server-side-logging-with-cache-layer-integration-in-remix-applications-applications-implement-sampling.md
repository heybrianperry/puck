# Implement Structured Server-Side Logging with Cache Layer Integration in Remix Applications: Applications Implement Sampling
...
1. MAY: Applications MAY implement sampling or rate limiting for high-volume logging to manage storage costs

## Policy Block

- MAY Applications MAY implement sampling or rate limiting for high-volume logging to manage storage costs
