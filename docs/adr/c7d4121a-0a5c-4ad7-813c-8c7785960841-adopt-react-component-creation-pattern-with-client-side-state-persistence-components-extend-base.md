...
1. MAY: Components MAY extend the base Template contract with additional properties specific to their use case

## Policy Block

- MAY Components MAY extend the base Template contract with additional properties specific to their use case
