# Adopt Catch-All Route Patterns for Dynamic Content Management Systems: Route Handlers Implement
...
1. SHOULD: Route handlers SHOULD implement consistent naming conventions for catch-all parameters that reflect the CMS or content domain (e.g., puckPath, cmsPath)

## Policy Block

- SHOULD Route handlers SHOULD implement consistent naming conventions for catch-all parameters that reflect the CMS or content domain (e.g., puckPath, cmsPath)
