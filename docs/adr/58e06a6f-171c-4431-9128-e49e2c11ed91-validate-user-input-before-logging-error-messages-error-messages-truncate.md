...
1. SHOULD: Error messages SHOULD truncate long user input values to a maximum length (e.g., 100 characters) when logging to prevent log overflow

## Policy Block

- SHOULD Error messages SHOULD truncate long user input values to a maximum length (e.g., 100 characters) when logging to prevent log overflow
