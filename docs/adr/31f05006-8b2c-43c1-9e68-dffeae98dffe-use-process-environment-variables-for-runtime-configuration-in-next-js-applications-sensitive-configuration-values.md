...
1. MUST_NOT: Sensitive configuration values MUST NOT use the NEXT_PUBLIC_ prefix to prevent client-side exposure

## Policy Block

- MUST_NOT Sensitive configuration values MUST NOT use the NEXT_PUBLIC_ prefix to prevent client-side exposure
