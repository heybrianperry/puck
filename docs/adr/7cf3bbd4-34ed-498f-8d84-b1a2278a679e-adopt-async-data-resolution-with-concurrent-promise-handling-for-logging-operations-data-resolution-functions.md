# Adopt Async Data Resolution with Concurrent Promise Handling for Logging Operations: Data Resolution Functions
...
1. MUST: Data resolution functions MUST return Promises to enable concurrent execution and composition

## Policy Block

- MUST Data resolution functions MUST return Promises to enable concurrent execution and composition
