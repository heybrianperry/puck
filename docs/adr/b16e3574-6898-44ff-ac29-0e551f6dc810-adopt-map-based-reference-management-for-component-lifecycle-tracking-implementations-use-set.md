...
1. MAY: Implementations MAY use Set data structures (e.g., nextPinnedIndexes.add) for tracking component collections where uniqueness and membership testing are primary operations

## Policy Block

- MAY Implementations MAY use Set data structures (e.g., nextPinnedIndexes.add) for tracking component collections where uniqueness and membership testing are primary operations
