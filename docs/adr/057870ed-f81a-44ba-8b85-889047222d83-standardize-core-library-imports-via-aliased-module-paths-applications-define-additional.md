...
1. MAY: Applications MAY define additional application-specific path aliases beyond the core library aliases

## Policy Block

- MAY Applications MAY define additional application-specific path aliases beyond the core library aliases
