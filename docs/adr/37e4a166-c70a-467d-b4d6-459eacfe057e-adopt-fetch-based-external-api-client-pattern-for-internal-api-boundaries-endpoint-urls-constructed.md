...
1. MUST: API endpoint URLs MUST be constructed using environment variables (process.env.NEXT_PUBLIC_*) to support environment-specific configuration

## Policy Block

- MUST API endpoint URLs MUST be constructed using environment variables (process.env.NEXT_PUBLIC_*) to support environment-specific configuration
