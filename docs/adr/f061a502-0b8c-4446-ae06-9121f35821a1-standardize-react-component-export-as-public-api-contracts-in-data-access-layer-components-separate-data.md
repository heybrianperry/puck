...
1. SHOULD: Components SHOULD separate data access logic from presentation through custom hooks or context providers (e.g., useFrame, autoFrameContext)

## Policy Block

- SHOULD Components SHOULD separate data access logic from presentation through custom hooks or context providers (e.g., useFrame, autoFrameContext)
