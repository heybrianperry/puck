# Adopt Modular Library Architecture with Core Package Pattern: Build Configuration Library
...
1. SHOULD: Build configuration for library packages SHOULD be centralized in dedicated config packages (e.g., packages/tsup-config)

## Policy Block

- SHOULD Build configuration for library packages SHOULD be centralized in dedicated config packages (e.g., packages/tsup-config)
