...
1. MUST_NOT: Server-side secrets (database credentials, private API keys, authentication tokens) MUST NOT use the NEXT_PUBLIC_ prefix

## Policy Block

- MUST_NOT Server-side secrets (database credentials, private API keys, authentication tokens) MUST NOT use the NEXT_PUBLIC_ prefix
