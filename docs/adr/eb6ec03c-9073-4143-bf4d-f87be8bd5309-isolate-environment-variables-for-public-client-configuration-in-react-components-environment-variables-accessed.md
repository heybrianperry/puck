...
1. MUST: All environment variables accessed in client-side React components MUST use the NEXT_PUBLIC_ prefix to explicitly mark them as client-exposed

## Policy Block

- MUST All environment variables accessed in client-side React components MUST use the NEXT_PUBLIC_ prefix to explicitly mark them as client-exposed
