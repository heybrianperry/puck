...
1. MUST: Virtualizer handles MUST be registered in the rootVirtualizers map using zone compound identifiers as keys, and MUST be removed on component unmount

## Policy Block

- MUST Virtualizer handles MUST be registered in the rootVirtualizers map using zone compound identifiers as keys, and MUST be removed on component unmount
