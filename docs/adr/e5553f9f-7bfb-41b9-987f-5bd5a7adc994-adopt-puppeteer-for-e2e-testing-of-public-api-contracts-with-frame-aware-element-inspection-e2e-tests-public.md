...
1. MUST: E2E tests for public API contracts MUST use Puppeteer as the browser automation library

## Policy Block

- MUST E2E tests for public API contracts MUST use Puppeteer as the browser automation library
