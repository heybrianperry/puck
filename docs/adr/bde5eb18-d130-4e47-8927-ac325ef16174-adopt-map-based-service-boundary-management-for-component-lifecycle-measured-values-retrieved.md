...
1. SHOULD: Measured values retrieved from registries SHOULD be validated for existence before use (e.g., measuredItemHeights.get(componentId) may return undefined)

## Policy Block

- SHOULD Measured values retrieved from registries SHOULD be validated for existence before use (e.g., measuredItemHeights.get(componentId) may return undefined)
