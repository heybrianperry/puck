...
1. MUST: CLI tools MUST read process.env.npm_config_user_agent to detect the invoking package manager

## Policy Block

- MUST CLI tools MUST read process.env.npm_config_user_agent to detect the invoking package manager
