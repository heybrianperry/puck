# Standardize Environment Variable Access via process.env for Runtime Configuration: Sensitive Configuration Values
...
1. MUST_NOT: Sensitive configuration values (API keys, secrets, credentials) MUST_NOT be committed to version control or included in client-side bundles

## Policy Block

- MUST_NOT Sensitive configuration values (API keys, secrets, credentials) MUST_NOT be committed to version control or included in client-side bundles
