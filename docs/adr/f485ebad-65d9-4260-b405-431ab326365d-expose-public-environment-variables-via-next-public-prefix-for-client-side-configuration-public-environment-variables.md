...
1. MUST: Public environment variables MUST be accessed via process.env.NEXT_PUBLIC_* syntax

## Policy Block

- MUST Public environment variables MUST be accessed via process.env.NEXT_PUBLIC_* syntax
