...
1. MUST: Use Array.find(predicate) for locating elements in collections where identity is determined by property comparison (e.g., path matching, href matching, option value matching)

## Policy Block

- MUST Use Array.find(predicate) for locating elements in collections where identity is determined by property comparison (e.g., path matching, href matching, option value matching)
