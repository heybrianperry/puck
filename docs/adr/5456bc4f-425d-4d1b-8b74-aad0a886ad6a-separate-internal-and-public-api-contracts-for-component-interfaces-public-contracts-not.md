...
1. MUST: Public API contracts MUST NOT expose internal implementation details, private state, or framework-specific types

## Policy Block

- MUST Public API contracts MUST NOT expose internal implementation details, private state, or framework-specific types
