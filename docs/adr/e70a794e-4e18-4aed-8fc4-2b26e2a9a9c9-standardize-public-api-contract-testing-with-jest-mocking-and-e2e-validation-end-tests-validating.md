...
1. MUST: End-to-end tests validating browser-based API contracts MUST use puppeteer with page.evaluate, page.goto, and browser.newPage to verify runtime behavior in actual browser contexts

## Policy Block

- MUST End-to-end tests validating browser-based API contracts MUST use puppeteer with page.evaluate, page.goto, and browser.newPage to verify runtime behavior in actual browser contexts
