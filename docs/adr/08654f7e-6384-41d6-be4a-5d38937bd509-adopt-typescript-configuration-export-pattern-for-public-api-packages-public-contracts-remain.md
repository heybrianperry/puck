# Adopt TypeScript Configuration Export Pattern for Public API Packages: Public Contracts Remain
...
1. SHOULD: Public API contracts SHOULD remain framework-agnostic where possible, with framework-specific adapters provided separately

## Policy Block

- SHOULD Public API contracts SHOULD remain framework-agnostic where possible, with framework-specific adapters provided separately
