# Adopt Explicit Export Pattern for Library Module Public APIs: Server Specific Modules
...
1. SHOULD: Server-specific modules (e.g., server.tsx) SHOULD be clearly distinguished from client modules to prevent bundling errors

## Policy Block

- SHOULD Server-specific modules (e.g., server.tsx) SHOULD be clearly distinguished from client modules to prevent bundling errors
