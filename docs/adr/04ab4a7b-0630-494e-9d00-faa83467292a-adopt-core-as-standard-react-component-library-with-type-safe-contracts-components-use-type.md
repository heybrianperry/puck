...
1. SHOULD: Components SHOULD use type-safe imports from @/core/types for shared type definitions to maintain consistency

## Policy Block

- SHOULD Components SHOULD use type-safe imports from @/core/types for shared type definitions to maintain consistency
