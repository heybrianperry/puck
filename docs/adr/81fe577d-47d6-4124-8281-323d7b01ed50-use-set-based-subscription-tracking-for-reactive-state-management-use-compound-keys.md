...
1. SHOULD: Use compound keys (e.g., zoneCompound) when indexing virtualizers or handlers that span multiple logical boundaries

## Policy Block

- SHOULD Use compound keys (e.g., zoneCompound) when indexing virtualizers or handlers that span multiple logical boundaries
