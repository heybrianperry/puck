...
1. MUST_NOT: Public API components MUST NOT expose internal data structures (Map, Set, subscription handles) directly in their props or return types

## Policy Block

- MUST_NOT Public API components MUST NOT expose internal data structures (Map, Set, subscription handles) directly in their props or return types
