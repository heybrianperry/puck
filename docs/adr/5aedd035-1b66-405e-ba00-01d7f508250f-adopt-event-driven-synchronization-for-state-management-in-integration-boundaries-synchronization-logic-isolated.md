# Adopt Event-Driven Synchronization for State Management in Integration Boundaries: Synchronization Logic Isolated
...
1. SHOULD: Synchronization logic SHOULD be isolated from business logic to enable independent testing and maintenance

## Policy Block

- SHOULD Synchronization logic SHOULD be isolated from business logic to enable independent testing and maintenance
