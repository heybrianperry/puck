...
1. SHOULD: State updates that affect multiple zones SHOULD use Set data structures (nextPinnedIndexes) to track unique indexes and avoid duplicate processing

## Policy Block

- SHOULD State updates that affect multiple zones SHOULD use Set data structures (nextPinnedIndexes) to track unique indexes and avoid duplicate processing
