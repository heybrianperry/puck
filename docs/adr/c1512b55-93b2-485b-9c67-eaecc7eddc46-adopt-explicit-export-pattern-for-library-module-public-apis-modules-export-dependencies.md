# Adopt Explicit Export Pattern for Library Module Public APIs: Modules Export Dependencies
...
1. MAY: Modules MAY re-export dependencies to provide a stable facade over third-party libraries

## Policy Block

- MAY Modules MAY re-export dependencies to provide a stable facade over third-party libraries
