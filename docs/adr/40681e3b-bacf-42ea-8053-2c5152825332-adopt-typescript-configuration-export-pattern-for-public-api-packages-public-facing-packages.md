# Adopt TypeScript Configuration Export Pattern for Public API Packages: Public Facing Packages
...
1. MUST: All public-facing packages MUST define their exports through explicit configuration files (tsup.config.ts, package.json exports field, or equivalent)

## Policy Block

- MUST All public-facing packages MUST define their exports through explicit configuration files (tsup.config.ts, package.json exports field, or equivalent)
