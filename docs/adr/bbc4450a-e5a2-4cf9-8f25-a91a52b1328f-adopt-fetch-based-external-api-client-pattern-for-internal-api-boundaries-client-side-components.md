...
1. MUST: Client-side components MUST use the native fetch API to communicate with internal API routes when dynamic data retrieval is required at runtime

## Policy Block

- MUST Client-side components MUST use the native fetch API to communicate with internal API routes when dynamic data retrieval is required at runtime
