# Enforce Input Validation and Boundary Checking for Configuration Parameters: Numeric Configuration Parameters
...
1. MUST: Numeric configuration parameters MUST have defined minimum and maximum bounds that are enforced at runtime

## Policy Block

- MUST Numeric configuration parameters MUST have defined minimum and maximum bounds that are enforced at runtime
