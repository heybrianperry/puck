# Standardize Environment Variable Configuration for Runtime Execution Context: Environment Configuration Access
...
1. MUST: Environment configuration access patterns MUST be consistent across all framework implementations (Remix, Next.js) within the codebase

## Policy Block

- MUST Environment configuration access patterns MUST be consistent across all framework implementations (Remix, Next.js) within the codebase
