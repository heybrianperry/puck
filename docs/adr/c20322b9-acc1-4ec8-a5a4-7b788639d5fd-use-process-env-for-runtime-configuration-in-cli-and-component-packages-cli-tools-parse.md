...
1. MAY: CLI tools MAY parse structured data from environment variables (e.g., user agent strings) to derive configuration

## Policy Block

- MAY CLI tools MAY parse structured data from environment variables (e.g., user agent strings) to derive configuration
