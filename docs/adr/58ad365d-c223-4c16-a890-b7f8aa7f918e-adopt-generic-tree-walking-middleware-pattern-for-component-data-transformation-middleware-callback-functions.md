...
1. MUST: Middleware callback functions MUST receive both the content node and contextual options (parentId, propName) to enable context-aware transformations

## Policy Block

- MUST Middleware callback functions MUST receive both the content node and contextual options (parentId, propName) to enable context-aware transformations
