...
1. SHOULD_NOT: Avoid direct object property access or array indexing when component identity is dynamic or requires predicate-based matching

## Policy Block

- SHOULD_NOT Avoid direct object property access or array indexing when component identity is dynamic or requires predicate-based matching
