...
1. SHOULD: Measurement cache access SHOULD occur within useCallback, useMemo, or useEffect hooks to optimize performance

## Policy Block

- SHOULD Measurement cache access SHOULD occur within useCallback, useMemo, or useEffect hooks to optimize performance
