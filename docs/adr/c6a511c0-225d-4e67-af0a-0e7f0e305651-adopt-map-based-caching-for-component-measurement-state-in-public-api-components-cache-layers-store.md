...
1. MAY: Cache layers MAY store virtualizer handles (rootVirtualizers.set/delete) or measurement refs (measureRefsRef.current.set/get) depending on component requirements

## Policy Block

- MAY Cache layers MAY store virtualizer handles (rootVirtualizers.set/delete) or measurement refs (measureRefsRef.current.set/get) depending on component requirements
