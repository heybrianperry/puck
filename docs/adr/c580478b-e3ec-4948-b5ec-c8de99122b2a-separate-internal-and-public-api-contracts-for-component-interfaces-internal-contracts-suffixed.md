...
1. SHOULD: Internal contracts SHOULD be suffixed with 'Internal' or placed in separate internal modules to signal visibility boundaries

## Policy Block

- SHOULD Internal contracts SHOULD be suffixed with 'Internal' or placed in separate internal modules to signal visibility boundaries
