# Standardize External API Documentation with Embedded Analytics and Metadata: Documentation Sites Implement
...
1. SHOULD: Documentation sites SHOULD implement consistent theme configuration patterns across all documentation surfaces

## Policy Block

- SHOULD Documentation sites SHOULD implement consistent theme configuration patterns across all documentation surfaces
