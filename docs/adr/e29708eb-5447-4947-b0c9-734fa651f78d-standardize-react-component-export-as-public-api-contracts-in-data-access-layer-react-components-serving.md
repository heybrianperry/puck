...
1. MUST: React components serving as public API contracts MUST be exported with explicit TypeScript types or interfaces (e.g., VirtualizedDropZone, DragDropContext, AutoFrameProps)

## Policy Block

- MUST React components serving as public API contracts MUST be exported with explicit TypeScript types or interfaces (e.g., VirtualizedDropZone, DragDropContext, AutoFrameProps)
