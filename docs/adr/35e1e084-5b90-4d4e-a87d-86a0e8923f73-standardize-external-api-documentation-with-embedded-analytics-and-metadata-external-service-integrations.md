# Standardize External API Documentation with Embedded Analytics and Metadata: External Service Integrations
...
1. SHOULD: External service integrations (analytics, error tracking) SHOULD be conditionally loaded based on environment to avoid tracking in development

## Policy Block

- SHOULD External service integrations (analytics, error tracking) SHOULD be conditionally loaded based on environment to avoid tracking in development
