# Adopt Catch-All Route Patterns for Dynamic Content Management Systems: Route Implementations Handle
...
1. MUST: Route implementations MUST handle both root path access (empty catch-all) and nested paths consistently

## Policy Block

- MUST Route implementations MUST handle both root path access (empty catch-all) and nested paths consistently
