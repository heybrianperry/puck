# Enforce Input Validation and Boundary Checking for Configuration Parameters: Configuration Validation Use
...
1. MAY: Configuration validation MAY use schema validation libraries (e.g., Zod, Yup, Joi) to enforce complex validation rules declaratively

## Policy Block

- MAY Configuration validation MAY use schema validation libraries (e.g., Zod, Yup, Joi) to enforce complex validation rules declaratively
