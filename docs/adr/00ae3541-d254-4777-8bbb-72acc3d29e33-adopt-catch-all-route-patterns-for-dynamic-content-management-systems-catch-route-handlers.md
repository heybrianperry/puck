# Adopt Catch-All Route Patterns for Dynamic Content Management Systems: Catch Route Handlers
...
1. MUST: Catch-all route handlers MUST extract the full path from the framework-specific parameter and pass it to the CMS resolution layer without modification

## Policy Block

- MUST Catch-all route handlers MUST extract the full path from the framework-specific parameter and pass it to the CMS resolution layer without modification
