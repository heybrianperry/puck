# Adopt Snapshot Testing for Component and Reducer Unit Tests: Snapshot Tests Placed
...
1. SHOULD: Snapshot tests SHOULD be placed in __tests__ directories alongside the source files they verify

## Policy Block

- SHOULD Snapshot tests SHOULD be placed in __tests__ directories alongside the source files they verify
