...
1. MUST: Components MUST define separate TypeScript interfaces for internal contracts (e.g., TemplateInternal) and public contracts (e.g., Template)

## Policy Block

- MUST Components MUST define separate TypeScript interfaces for internal contracts (e.g., TemplateInternal) and public contracts (e.g., Template)
