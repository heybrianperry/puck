...
1. SHOULD: Components SHOULD define explicit fallback values that match the expected data structure rather than using generic empty objects

## Policy Block

- SHOULD Components SHOULD define explicit fallback values that match the expected data structure rather than using generic empty objects
