...
1. MAY: Middleware functions MAY use helper utilities like mapFields to recursively process nested data structures with slot-based content

## Policy Block

- MAY Middleware functions MAY use helper utilities like mapFields to recursively process nested data structures with slot-based content
