# Implement Server-Side Request Logging in Remix Entry Points: Remix Applications Implement
...
1. MUST: All Remix applications MUST implement request logging in the entry.server.tsx file to capture incoming HTTP requests

## Policy Block

- MUST All Remix applications MUST implement request logging in the entry.server.tsx file to capture incoming HTTP requests
