...
1. MUST: Predicates MUST use arrow function syntax with explicit property comparison (e.g., (item) => item.props.id === "target-id")

## Policy Block

- MUST Predicates MUST use arrow function syntax with explicit property comparison (e.g., (item) => item.props.id === "target-id")
