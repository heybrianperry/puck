...
1. MUST: Tests validating public API contracts MUST verify both data structure correctness (using expect().toEqual()) and path/index consistency in state management

## Policy Block

- MUST Tests validating public API contracts MUST verify both data structure correctness (using expect().toEqual()) and path/index consistency in state management
