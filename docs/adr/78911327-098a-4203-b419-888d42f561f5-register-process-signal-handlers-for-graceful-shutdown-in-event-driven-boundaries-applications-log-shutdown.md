...
1. MAY: Applications MAY log shutdown events to console.error or structured logging systems to aid debugging of interrupted operations

## Policy Block

- MAY Applications MAY log shutdown events to console.error or structured logging systems to aid debugging of interrupted operations
