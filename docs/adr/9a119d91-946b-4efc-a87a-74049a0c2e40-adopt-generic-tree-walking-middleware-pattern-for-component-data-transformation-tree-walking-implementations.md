...
1. MUST: Tree-walking implementations MUST handle all structural variants: single component data with props, root-level data, and full UserData with zones

## Policy Block

- MUST Tree-walking implementations MUST handle all structural variants: single component data with props, root-level data, and full UserData with zones
