# Standardize Environment Variable Access via process.env for Runtime Configuration: Environment Variable Access
...
1. MUST: Environment variable access MUST occur at the module or function scope where the configuration is needed, not at global initialization unless explicitly required

## Policy Block

- MUST Environment variable access MUST occur at the module or function scope where the configuration is needed, not at global initialization unless explicitly required
