# Implement Server-Side Request Logging in Remix Entry Points: Applications Implement Structured
...
1. MAY: Applications MAY implement structured logging formats (JSON) for easier parsing and analysis in log aggregation systems

## Policy Block

- MAY Applications MAY implement structured logging formats (JSON) for easier parsing and analysis in log aggregation systems
