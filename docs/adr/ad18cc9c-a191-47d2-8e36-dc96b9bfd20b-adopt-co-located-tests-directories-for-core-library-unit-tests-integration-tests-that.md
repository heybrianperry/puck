# Adopt Co-located __tests__ Directories for Core Library Unit Tests: Integration Tests That
...
1. MAY: Integration tests that span multiple modules MAY be organized in a dedicated __tests__/integration directory at the package root

## Policy Block

- MAY Integration tests that span multiple modules MAY be organized in a dedicated __tests__/integration directory at the package root
