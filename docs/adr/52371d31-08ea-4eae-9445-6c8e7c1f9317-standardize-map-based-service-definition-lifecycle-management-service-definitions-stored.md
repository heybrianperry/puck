...
1. MUST: Service definitions MUST be stored in Map data structures using component identifiers or compound keys as lookup keys

## Policy Block

- MUST Service definitions MUST be stored in Map data structures using component identifiers or compound keys as lookup keys
