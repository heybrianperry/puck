...
1. MUST: Use Map data structures for keyed UI state such as measured item heights, virtualizer handles, or component-specific measurement references where O(1) get/set/delete operations are required

## Policy Block

- MUST Use Map data structures for keyed UI state such as measured item heights, virtualizer handles, or component-specific measurement references where O(1) get/set/delete operations are required
