...
1. MUST: All environment variables intended for client-side access MUST use the NEXT_PUBLIC_ prefix

## Policy Block

- MUST All environment variables intended for client-side access MUST use the NEXT_PUBLIC_ prefix
