...
1. MUST: Component measurement data MUST be stored using Map.set() with component identifiers as keys and height values as values

## Policy Block

- MUST Component measurement data MUST be stored using Map.set() with component identifiers as keys and height values as values
