...
1. MUST: Configuration MUST expose NEXT_PUBLIC_IS_CANARY as a public environment variable for client-side canary detection

## Policy Block

- MUST Configuration MUST expose NEXT_PUBLIC_IS_CANARY as a public environment variable for client-side canary detection
