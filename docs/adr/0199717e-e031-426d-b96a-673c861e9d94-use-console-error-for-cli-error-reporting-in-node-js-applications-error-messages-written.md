...
1. MUST: Error messages MUST be written to stderr (via console.error) to enable proper stream separation from stdout

## Policy Block

- MUST Error messages MUST be written to stderr (via console.error) to enable proper stream separation from stdout
