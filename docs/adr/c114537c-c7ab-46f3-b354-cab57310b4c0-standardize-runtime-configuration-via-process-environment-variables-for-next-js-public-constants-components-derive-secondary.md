...
1. MAY: Components MAY derive secondary configuration values from primary process.env sources when logical transformations are required

## Policy Block

- MAY Components MAY derive secondary configuration values from primary process.env sources when logical transformations are required
