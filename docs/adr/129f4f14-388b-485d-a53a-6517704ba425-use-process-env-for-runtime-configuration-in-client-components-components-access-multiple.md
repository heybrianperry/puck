...
1. MAY: Components MAY access multiple related environment variables (BASE_URL, IS_CANARY, IS_LATEST) to support feature flags and environment-specific behavior

## Policy Block

- MAY Components MAY access multiple related environment variables (BASE_URL, IS_CANARY, IS_LATEST) to support feature flags and environment-specific behavior
