...
1. MUST: E2E test utilities MUST use browser-native rendering APIs to compute element properties and bounding boxes

## Policy Block

- MUST E2E test utilities MUST use browser-native rendering APIs to compute element properties and bounding boxes
