# Adopt Remix Route-Based Configuration Pattern for Service Boundaries: Route Modules Define
...
1. MUST: Route modules MUST define service boundaries explicitly through configuration objects or dependency injection at the route level

## Policy Block

- MUST Route modules MUST define service boundaries explicitly through configuration objects or dependency injection at the route level
