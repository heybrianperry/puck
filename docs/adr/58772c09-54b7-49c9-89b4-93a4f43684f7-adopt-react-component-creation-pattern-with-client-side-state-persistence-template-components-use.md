...
1. MUST: Template components MUST use the createComponent pattern for instantiation to ensure consistent lifecycle management

## Policy Block

- MUST Template components MUST use the createComponent pattern for instantiation to ensure consistent lifecycle management
