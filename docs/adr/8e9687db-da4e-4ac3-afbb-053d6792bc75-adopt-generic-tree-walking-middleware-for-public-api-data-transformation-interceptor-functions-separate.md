...
1. SHOULD: Interceptor functions SHOULD separate cross-cutting concerns (history recording, action logging) from core business logic through wrapper patterns

## Policy Block

- SHOULD Interceptor functions SHOULD separate cross-cutting concerns (history recording, action logging) from core business logic through wrapper patterns
