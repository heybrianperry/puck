...
1. MAY: Server-side only variables (without NEXT_PUBLIC_ prefix) MAY be accessed in API routes, getServerSideProps, and configuration files

## Policy Block

- MAY Server-side only variables (without NEXT_PUBLIC_ prefix) MAY be accessed in API routes, getServerSideProps, and configuration files
