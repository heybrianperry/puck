...
1. MUST: Each virtualized zone MUST maintain an independent measurement cache identified by a unique compound key (zoneCompound)

## Policy Block

- MUST Each virtualized zone MUST maintain an independent measurement cache identified by a unique compound key (zoneCompound)
