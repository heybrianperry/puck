...
1. MAY: Components MAY use Set data structures (nextPinnedIndexes.add) for boundary coordination when tracking unique values without associated metadata

## Policy Block

- MAY Components MAY use Set data structures (nextPinnedIndexes.add) for boundary coordination when tracking unique values without associated metadata
