...
1. MUST: Item height measurements in virtualized components MUST be cached using Map data structures keyed by component identifier

## Policy Block

- MUST Item height measurements in virtualized components MUST be cached using Map data structures keyed by component identifier
