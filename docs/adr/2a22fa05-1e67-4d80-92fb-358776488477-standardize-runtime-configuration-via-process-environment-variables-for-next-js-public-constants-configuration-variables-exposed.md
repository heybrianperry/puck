...
1. MUST: Configuration variables exposed to the browser runtime MUST use the NEXT_PUBLIC_ naming convention to ensure proper inlining during Next.js build process

## Policy Block

- MUST Configuration variables exposed to the browser runtime MUST use the NEXT_PUBLIC_ naming convention to ensure proper inlining during Next.js build process
