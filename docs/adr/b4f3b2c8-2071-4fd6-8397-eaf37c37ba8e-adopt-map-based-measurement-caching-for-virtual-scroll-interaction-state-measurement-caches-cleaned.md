...
1. MUST: Measurement caches MUST be cleaned up (delete operations) when components unmount or items are removed

## Policy Block

- MUST Measurement caches MUST be cleaned up (delete operations) when components unmount or items are removed
