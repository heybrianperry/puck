...
1. SHOULD: Contract transformation logic SHOULD be centralized in factory functions (e.g., createComponent) rather than scattered across component code

## Policy Block

- SHOULD Contract transformation logic SHOULD be centralized in factory functions (e.g., createComponent) rather than scattered across component code
