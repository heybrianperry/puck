# Adopt Co-located __tests__ Directories for Core Library Unit Tests: Unit Tests Packages
...
1. MUST: All unit tests for packages/core library modules MUST be placed in a __tests__ directory co-located with the source code under test

## Policy Block

- MUST All unit tests for packages/core library modules MUST be placed in a __tests__ directory co-located with the source code under test
