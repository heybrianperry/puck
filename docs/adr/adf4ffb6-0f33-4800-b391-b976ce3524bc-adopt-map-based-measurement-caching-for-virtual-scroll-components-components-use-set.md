...
1. MAY: Components MAY use Set data structures for tracking pinned indexes or other non-measurement state related to virtualization

## Policy Block

- MAY Components MAY use Set data structures for tracking pinned indexes or other non-measurement state related to virtualization
