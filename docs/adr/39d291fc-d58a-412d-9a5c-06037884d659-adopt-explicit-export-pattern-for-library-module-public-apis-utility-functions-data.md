# Adopt Explicit Export Pattern for Library Module Public APIs: Utility Functions Data
...
1. MUST: Utility functions and data transformation modules MUST be self-contained with no side effects at module load time

## Policy Block

- MUST Utility functions and data transformation modules MUST be self-contained with no side effects at module load time
