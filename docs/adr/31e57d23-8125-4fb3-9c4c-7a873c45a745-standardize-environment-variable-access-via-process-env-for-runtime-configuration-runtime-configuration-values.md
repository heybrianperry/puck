# Standardize Environment Variable Access via process.env for Runtime Configuration: Runtime Configuration Values
...
1. MUST: All runtime configuration values MUST be accessed via process.env rather than hardcoded in application code

## Policy Block

- MUST All runtime configuration values MUST be accessed via process.env rather than hardcoded in application code
