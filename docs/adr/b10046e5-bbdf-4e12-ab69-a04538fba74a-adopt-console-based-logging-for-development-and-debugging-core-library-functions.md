# Adopt Console-Based Logging for Development and Debugging: Core Library Functions
...
1. MUST: All core library functions MUST use console methods (console.log, console.warn, console.error) for logging and debugging output

## Policy Block

- MUST All core library functions MUST use console methods (console.log, console.warn, console.error) for logging and debugging output
