...
1. SHOULD: External API calls SHOULD be initiated within useEffect hooks to ensure proper React lifecycle management

## Policy Block

- SHOULD External API calls SHOULD be initiated within useEffect hooks to ensure proper React lifecycle management
