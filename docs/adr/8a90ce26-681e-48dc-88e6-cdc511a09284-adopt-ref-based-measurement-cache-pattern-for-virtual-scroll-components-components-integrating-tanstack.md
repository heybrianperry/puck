...
1. MUST: Components integrating @tanstack/react-virtual MUST store measurement data (measuredItemHeights) and measurement refs (measureRefsRef) in mutable ref containers accessed via .current

## Policy Block

- MUST Components integrating @tanstack/react-virtual MUST store measurement data (measuredItemHeights) and measurement refs (measureRefsRef) in mutable ref containers accessed via .current
