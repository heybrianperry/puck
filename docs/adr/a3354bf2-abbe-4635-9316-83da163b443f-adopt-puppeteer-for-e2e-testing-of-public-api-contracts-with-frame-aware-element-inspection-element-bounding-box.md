...
1. MUST: Element bounding box calculations MUST apply frame transformations to return accurate coordinates relative to the viewport

## Policy Block

- MUST Element bounding box calculations MUST apply frame transformations to return accurate coordinates relative to the viewport
