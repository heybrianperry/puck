# Adopt Client-Side Rendering Pattern for External API Integration in Dynamic Content Editors: Client Side Integration
...
1. MUST: Client-side API integration components MUST be isolated in dedicated files with clear naming conventions (e.g., client.tsx, *.client.tsx) to distinguish them from server-rendered components

## Policy Block

- MUST Client-side API integration components MUST be isolated in dedicated files with clear naming conventions (e.g., client.tsx, *.client.tsx) to distinguish them from server-rendered components
