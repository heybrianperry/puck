...
1. SHOULD: Environment-specific flags (IS_CANARY, IS_LATEST) SHOULD be exposed via NEXT_PUBLIC_ prefixed variables when they affect client-side behavior

## Policy Block

- SHOULD Environment-specific flags (IS_CANARY, IS_LATEST) SHOULD be exposed via NEXT_PUBLIC_ prefixed variables when they affect client-side behavior
