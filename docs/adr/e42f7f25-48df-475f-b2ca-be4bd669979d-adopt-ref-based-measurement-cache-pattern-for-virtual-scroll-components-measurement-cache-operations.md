...
1. MUST: Measurement cache operations (get, set, delete) MUST be performed imperatively within useEffect cleanup functions or event handlers to avoid triggering React re-renders

## Policy Block

- MUST Measurement cache operations (get, set, delete) MUST be performed imperatively within useEffect cleanup functions or event handlers to avoid triggering React re-renders
