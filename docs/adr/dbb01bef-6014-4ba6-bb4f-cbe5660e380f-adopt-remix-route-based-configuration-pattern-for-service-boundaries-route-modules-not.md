# Adopt Remix Route-Based Configuration Pattern for Service Boundaries: Route Modules Not
...
1. MUST_NOT: Route modules MUST NOT access global configuration state directly; all configuration MUST flow through route-level loaders or context providers

## Policy Block

- MUST_NOT Route modules MUST NOT access global configuration state directly; all configuration MUST flow through route-level loaders or context providers
