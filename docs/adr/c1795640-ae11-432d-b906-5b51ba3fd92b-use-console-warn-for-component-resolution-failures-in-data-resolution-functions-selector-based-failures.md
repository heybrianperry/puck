...
1. SHOULD: Selector-based failures SHOULD serialize the selector using JSON.stringify for readability

## Policy Block

- SHOULD Selector-based failures SHOULD serialize the selector using JSON.stringify for readability
