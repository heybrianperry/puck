...
1. SHOULD: External API calls constructed from environment variables SHOULD log the failure with sufficient context to identify misconfiguration

## Policy Block

- SHOULD External API calls constructed from environment variables SHOULD log the failure with sufficient context to identify misconfiguration
