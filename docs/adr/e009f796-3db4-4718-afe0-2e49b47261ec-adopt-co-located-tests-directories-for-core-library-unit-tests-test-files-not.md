# Adopt Co-located __tests__ Directories for Core Library Unit Tests: Test Files Not
...
1. MUST_NOT: Test files MUST NOT be placed in separate top-level test directories disconnected from the source code they test

## Policy Block

- MUST_NOT Test files MUST NOT be placed in separate top-level test directories disconnected from the source code they test
