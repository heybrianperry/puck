...
1. MUST: React components that serve as public APIs MUST export both an internal interface (suffixed with 'Internal') and a public interface for external consumption

## Policy Block

- MUST React components that serve as public APIs MUST export both an internal interface (suffixed with 'Internal') and a public interface for external consumption
