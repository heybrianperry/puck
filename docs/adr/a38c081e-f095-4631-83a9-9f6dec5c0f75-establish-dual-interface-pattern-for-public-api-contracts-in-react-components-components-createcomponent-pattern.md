...
1. MUST: Components using the createComponent pattern MUST define their contracts before implementation to ensure type safety across the factory boundary

## Policy Block

- MUST Components using the createComponent pattern MUST define their contracts before implementation to ensure type safety across the factory boundary
