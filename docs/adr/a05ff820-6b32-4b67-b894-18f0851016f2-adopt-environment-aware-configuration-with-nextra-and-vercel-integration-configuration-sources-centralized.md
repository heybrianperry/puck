...
1. SHOULD: Configuration sources SHOULD be centralized in next.config.mjs to maintain a single source of truth

## Policy Block

- SHOULD Configuration sources SHOULD be centralized in next.config.mjs to maintain a single source of truth
