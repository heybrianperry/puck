# Adopt Modular Library Architecture with Core Package Pattern: Components That Support
...
1. MUST: Components that support server-side rendering MUST provide separate server.tsx implementations alongside client components

## Policy Block

- MUST Components that support server-side rendering MUST provide separate server.tsx implementations alongside client components
