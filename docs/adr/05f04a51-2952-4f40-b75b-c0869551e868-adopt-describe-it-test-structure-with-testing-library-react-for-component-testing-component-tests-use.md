...
1. MUST: Component tests MUST use @testing-library/react for rendering and interacting with React components

## Policy Block

- MUST Component tests MUST use @testing-library/react for rendering and interacting with React components
