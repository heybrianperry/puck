...
1. MAY: Components MAY access process.env directly for NEXT_PUBLIC_ variables as they are replaced at build time

## Policy Block

- MAY Components MAY access process.env directly for NEXT_PUBLIC_ variables as they are replaced at build time
