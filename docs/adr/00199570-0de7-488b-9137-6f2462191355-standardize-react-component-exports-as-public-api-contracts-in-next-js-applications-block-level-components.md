...
1. SHOULD: Block-level components SHOULD co-locate styles using CSS modules with the naming pattern styles.module.css

## Policy Block

- SHOULD Block-level components SHOULD co-locate styles using CSS modules with the naming pattern styles.module.css
