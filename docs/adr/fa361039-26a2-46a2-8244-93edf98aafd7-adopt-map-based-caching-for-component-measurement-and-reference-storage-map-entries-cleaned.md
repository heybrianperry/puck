...
1. MUST: Map entries MUST be cleaned up using Map.delete() when components unmount or are removed from the virtualized list

## Policy Block

- MUST Map entries MUST be cleaned up using Map.delete() when components unmount or are removed from the virtualized list
