# Adopt TypeScript Configuration Export Pattern for Public API Packages: Packages Provide Multiple
...
1. MAY: Packages MAY provide multiple export entry points for different use cases (e.g., main, client, server) when appropriate

## Policy Block

- MAY Packages MAY provide multiple export entry points for different use cases (e.g., main, client, server) when appropriate
