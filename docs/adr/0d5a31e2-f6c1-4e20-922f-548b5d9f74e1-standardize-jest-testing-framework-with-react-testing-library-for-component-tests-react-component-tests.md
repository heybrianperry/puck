# Standardize Jest Testing Framework with React Testing Library for Component Tests: React Component Tests
...
1. MUST: React component tests MUST use React Testing Library for rendering and interaction testing

## Policy Block

- MUST React component tests MUST use React Testing Library for rendering and interaction testing
