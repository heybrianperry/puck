...
1. SHOULD: Components SHOULD clean up cache entries via delete operations when components unmount or are removed from the virtual list

## Policy Block

- SHOULD Components SHOULD clean up cache entries via delete operations when components unmount or are removed from the virtual list
