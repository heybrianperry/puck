# Adopt Jest and React Testing Library for Component Testing: Component Tests Use
...
1. MUST: Component tests MUST use React Testing Library for rendering and querying React components

## Policy Block

- MUST Component tests MUST use React Testing Library for rendering and querying React components
