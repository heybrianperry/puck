# Enforce Input Validation and Boundary Checking for Configuration Parameters: Configuration Parameters Have
...
1. SHOULD: Configuration parameters SHOULD have documented default values that are used when optional parameters are not provided

## Policy Block

- SHOULD Configuration parameters SHOULD have documented default values that are used when optional parameters are not provided
