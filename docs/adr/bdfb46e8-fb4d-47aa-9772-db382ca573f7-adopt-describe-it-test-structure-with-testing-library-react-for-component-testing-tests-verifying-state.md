...
1. SHOULD: Tests verifying state updates SHOULD test both the dispatch action and the resulting preview changes

## Policy Block

- SHOULD Tests verifying state updates SHOULD test both the dispatch action and the resulting preview changes
