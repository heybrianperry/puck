...
1. MUST: Use Array.find() with predicate functions for querying arrays when a single matching element is required

## Policy Block

- MUST Use Array.find() with predicate functions for querying arrays when a single matching element is required
