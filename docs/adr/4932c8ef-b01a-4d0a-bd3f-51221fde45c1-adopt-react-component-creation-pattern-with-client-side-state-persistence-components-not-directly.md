...
1. MUST_NOT: Components MUST NOT directly parse localStorage values without null coalescing or error handling

## Policy Block

- MUST_NOT Components MUST NOT directly parse localStorage values without null coalescing or error handling
