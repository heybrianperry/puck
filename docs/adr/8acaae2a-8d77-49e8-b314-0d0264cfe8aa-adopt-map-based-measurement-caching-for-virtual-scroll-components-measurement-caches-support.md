...
1. MUST: Measurement caches MUST support get, set, and delete operations using component IDs as keys

## Policy Block

- MUST Measurement caches MUST support get, set, and delete operations using component IDs as keys
