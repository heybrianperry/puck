...
1. MUST: Public API contracts (UserConfig, UserData, setup, getBox, etc.) MUST be validated through automated tests at both unit and integration boundaries

## Policy Block

- MUST Public API contracts (UserConfig, UserData, setup, getBox, etc.) MUST be validated through automated tests at both unit and integration boundaries
