...
1. MUST_NOT: Component resolution failures MUST NOT throw exceptions or use console.error unless the failure represents an unrecoverable error

## Policy Block

- MUST_NOT Component resolution failures MUST NOT throw exceptions or use console.error unless the failure represents an unrecoverable error
