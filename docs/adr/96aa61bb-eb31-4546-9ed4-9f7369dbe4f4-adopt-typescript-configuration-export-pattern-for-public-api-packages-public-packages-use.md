# Adopt TypeScript Configuration Export Pattern for Public API Packages: Public Packages Use
...
1. SHOULD: Public packages SHOULD use shared build configuration (e.g., tsup-config package) to maintain consistency across the monorepo

## Policy Block

- SHOULD Public packages SHOULD use shared build configuration (e.g., tsup-config package) to maintain consistency across the monorepo
