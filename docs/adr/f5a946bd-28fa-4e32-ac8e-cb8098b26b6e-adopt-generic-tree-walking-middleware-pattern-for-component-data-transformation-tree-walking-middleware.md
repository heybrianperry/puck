...
1. MUST: Tree-walking middleware functions MUST accept generic type parameters that extend ComponentData, RootData, or UserData to preserve type information through transformations

## Policy Block

- MUST Tree-walking middleware functions MUST accept generic type parameters that extend ComponentData, RootData, or UserData to preserve type information through transformations
