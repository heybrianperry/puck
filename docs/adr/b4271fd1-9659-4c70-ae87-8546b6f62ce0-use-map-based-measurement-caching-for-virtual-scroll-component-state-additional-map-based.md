...
1. MAY: Additional Map-based caches MAY be used for related state such as virtualizer handles (rootVirtualizers) or index tracking (nextPinnedIndexes)

## Policy Block

- MAY Additional Map-based caches MAY be used for related state such as virtualizer handles (rootVirtualizers) or index tracking (nextPinnedIndexes)
