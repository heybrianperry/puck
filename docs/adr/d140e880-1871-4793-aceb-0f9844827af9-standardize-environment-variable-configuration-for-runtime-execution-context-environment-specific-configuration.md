# Standardize Environment Variable Configuration for Runtime Execution Context: Environment Specific Configuration
...
1. SHOULD: Environment-specific configuration SHOULD be isolated in dedicated configuration modules or files (e.g., *.server.ts for server-only config)

## Policy Block

- SHOULD Environment-specific configuration SHOULD be isolated in dedicated configuration modules or files (e.g., *.server.ts for server-only config)
