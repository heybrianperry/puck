# Adopt Snapshot Testing for Component and Reducer Unit Tests: Unit Tests State
...
1. MUST: Unit tests for state transformation functions (reducers, tree-walking utilities) MUST use snapshot testing to verify output data structures

## Policy Block

- MUST Unit tests for state transformation functions (reducers, tree-walking utilities) MUST use snapshot testing to verify output data structures
