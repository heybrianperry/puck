...
1. SHOULD: Selector-based lookups SHOULD serialize the selector using JSON.stringify in warning messages to provide complete diagnostic information

## Policy Block

- SHOULD Selector-based lookups SHOULD serialize the selector using JSON.stringify in warning messages to provide complete diagnostic information
