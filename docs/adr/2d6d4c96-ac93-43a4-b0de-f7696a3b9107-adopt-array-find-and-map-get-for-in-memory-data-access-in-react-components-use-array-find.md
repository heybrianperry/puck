...
1. SHOULD: Use Array.find() with predicate functions when searching collections for items matching specific criteria

## Policy Block

- SHOULD Use Array.find() with predicate functions when searching collections for items matching specific criteria
