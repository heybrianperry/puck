# Adopt Modular Library Architecture with Core Package Pattern: Reusable Components Organized
...
1. MUST: Reusable UI components MUST be organized in packages/core/components with index.tsx as the primary export file

## Policy Block

- MUST Reusable UI components MUST be organized in packages/core/components with index.tsx as the primary export file
