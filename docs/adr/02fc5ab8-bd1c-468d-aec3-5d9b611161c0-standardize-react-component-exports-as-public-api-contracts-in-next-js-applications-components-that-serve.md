...
1. SHOULD: Components that serve as application entry points (middleware, _app) SHOULD export Next.js-specific configuration objects alongside the primary export

## Policy Block

- SHOULD Components that serve as application entry points (middleware, _app) SHOULD export Next.js-specific configuration objects alongside the primary export
