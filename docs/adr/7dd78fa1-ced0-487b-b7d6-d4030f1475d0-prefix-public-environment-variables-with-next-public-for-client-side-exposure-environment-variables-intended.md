...
1. MUST: All environment variables intended for client-side access MUST be prefixed with NEXT_PUBLIC_

## Policy Block

- MUST All environment variables intended for client-side access MUST be prefixed with NEXT_PUBLIC_
