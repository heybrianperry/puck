...
1. MAY: Applications MAY implement additional sanitization layers for localStorage data that will be rendered in the DOM or used in dynamic code execution

## Policy Block

- MAY Applications MAY implement additional sanitization layers for localStorage data that will be rendered in the DOM or used in dynamic code execution
