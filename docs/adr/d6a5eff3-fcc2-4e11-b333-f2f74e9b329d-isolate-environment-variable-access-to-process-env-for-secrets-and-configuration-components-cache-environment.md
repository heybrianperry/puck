...
1. MAY: Components MAY cache environment variable values after initial access to avoid repeated process.env lookups

## Policy Block

- MAY Components MAY cache environment variable values after initial access to avoid repeated process.env lookups
