...
1. SHOULD: JSON.parse operations on user-controlled data SHOULD wrap parsing in try-catch blocks and log sanitized error details rather than raw input

## Policy Block

- SHOULD JSON.parse operations on user-controlled data SHOULD wrap parsing in try-catch blocks and log sanitized error details rather than raw input
