...
1. MUST: Component lifecycle resources MUST support get, set, and delete operations through the Map-based registry interface

## Policy Block

- MUST Component lifecycle resources MUST support get, set, and delete operations through the Map-based registry interface
