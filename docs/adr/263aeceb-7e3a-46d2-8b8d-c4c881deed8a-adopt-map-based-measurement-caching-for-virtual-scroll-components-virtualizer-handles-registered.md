...
1. SHOULD: Virtualizer handles SHOULD be registered in a Map structure keyed by zone compound identifiers for multi-zone coordination

## Policy Block

- SHOULD Virtualizer handles SHOULD be registered in a Map structure keyed by zone compound identifiers for multi-zone coordination
