...
1. MUST_NOT: Packages MUST NOT assume environment variables are always present; provide fallback behavior for missing values

## Policy Block

- MUST_NOT Packages MUST NOT assume environment variables are always present; provide fallback behavior for missing values
