# Implement Message Queue Logging for State Management Operations: Sensitive Data Message
...
1. SHOULD: Sensitive data in message payloads SHOULD be redacted or masked in logs

## Policy Block

- SHOULD Sensitive data in message payloads SHOULD be redacted or masked in logs
