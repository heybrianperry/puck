# Adopt Jest and React Testing Library for Component Testing: Test Files Use
...
1. MUST: All test files MUST use the .spec.tsx or .spec.ts extension for TypeScript test files

## Policy Block

- MUST All test files MUST use the .spec.tsx or .spec.ts extension for TypeScript test files
