...
1. SHOULD: Components SHOULD access process.env configuration values at the module or component initialization scope rather than within render loops

## Policy Block

- SHOULD Components SHOULD access process.env configuration values at the module or component initialization scope rather than within render loops
