...
1. SHOULD: Public configuration values SHOULD be documented in environment variable reference documentation

## Policy Block

- SHOULD Public configuration values SHOULD be documented in environment variable reference documentation
