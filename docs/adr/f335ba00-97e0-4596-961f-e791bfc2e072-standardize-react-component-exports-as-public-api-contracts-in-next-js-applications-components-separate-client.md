...
1. MAY: Components MAY separate client and server implementations (client.tsx, server.tsx) while maintaining consistent public API exports

## Policy Block

- MAY Components MAY separate client and server implementations (client.tsx, server.tsx) while maintaining consistent public API exports
