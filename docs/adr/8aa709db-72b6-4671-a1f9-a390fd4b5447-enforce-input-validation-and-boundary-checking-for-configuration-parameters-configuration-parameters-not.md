# Enforce Input Validation and Boundary Checking for Configuration Parameters: Configuration Parameters Not
...
1. MUST_NOT: Configuration parameters MUST NOT be directly interpolated into system commands, database queries, or file paths without sanitization

## Policy Block

- MUST_NOT Configuration parameters MUST NOT be directly interpolated into system commands, database queries, or file paths without sanitization
