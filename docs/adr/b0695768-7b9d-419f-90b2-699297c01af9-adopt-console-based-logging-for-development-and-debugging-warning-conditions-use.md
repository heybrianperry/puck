# Adopt Console-Based Logging for Development and Debugging: Warning Conditions Use
...
1. SHOULD: Warning conditions SHOULD use console.warn to distinguish severity levels from informational logs

## Policy Block

- SHOULD Warning conditions SHOULD use console.warn to distinguish severity levels from informational logs
