...
1. MUST: Perform Map.delete(key) cleanup operations in useEffect return functions or component unmount handlers to prevent memory leaks in long-lived component trees

## Policy Block

- MUST Perform Map.delete(key) cleanup operations in useEffect return functions or component unmount handlers to prevent memory leaks in long-lived component trees
