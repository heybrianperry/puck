# Implement Console Logging with Conditional Debug Output for Development Observability: Any Data Logged
...
1. MUST: Any data logged MUST be sanitized to remove or redact sensitive fields before being passed to console methods

## Policy Block

- MUST Any data logged MUST be sanitized to remove or redact sensitive fields before being passed to console methods
