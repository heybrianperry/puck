...
1. MUST_NOT: Sensitive credentials, API keys, or secrets MUST NOT use the NEXT_PUBLIC_ prefix

## Policy Block

- MUST_NOT Sensitive credentials, API keys, or secrets MUST NOT use the NEXT_PUBLIC_ prefix
