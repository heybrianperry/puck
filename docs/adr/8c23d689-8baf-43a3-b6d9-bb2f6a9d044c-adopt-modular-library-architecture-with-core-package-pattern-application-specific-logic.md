# Adopt Modular Library Architecture with Core Package Pattern: Application Specific Logic
...
1. MUST_NOT: Application-specific logic MUST NOT be placed in the core package; it should remain in application directories (e.g., recipes/)

## Policy Block

- MUST_NOT Application-specific logic MUST NOT be placed in the core package; it should remain in application directories (e.g., recipes/)
