# Adopt Modular Library Architecture with Core Package Pattern: Custom React Hooks
...
1. SHOULD: Custom React hooks SHOULD follow the use-* naming convention and be placed in packages/core/lib

## Policy Block

- SHOULD Custom React hooks SHOULD follow the use-* naming convention and be placed in packages/core/lib
