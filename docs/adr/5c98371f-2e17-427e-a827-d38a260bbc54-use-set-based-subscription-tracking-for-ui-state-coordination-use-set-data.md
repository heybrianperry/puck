...
1. MUST: Use Set data structures for tracking unique UI state identifiers such as pinned indexes, active zones, or selected items where membership testing is the primary operation

## Policy Block

- MUST Use Set data structures for tracking unique UI state identifiers such as pinned indexes, active zones, or selected items where membership testing is the primary operation
