# Standardize Message Queue Integration for Public API Event Distribution: Event Schemas Versioned
...
1. SHOULD: Event schemas SHOULD be versioned to support backward compatibility as APIs evolve

## Policy Block

- SHOULD Event schemas SHOULD be versioned to support backward compatibility as APIs evolve
