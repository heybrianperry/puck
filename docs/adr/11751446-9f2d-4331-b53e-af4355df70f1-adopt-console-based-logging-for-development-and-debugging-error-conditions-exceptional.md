# Adopt Console-Based Logging for Development and Debugging: Error Conditions Exceptional
...
1. MUST: Error conditions and exceptional states MUST be logged using console.error with descriptive context

## Policy Block

- MUST Error conditions and exceptional states MUST be logged using console.error with descriptive context
