...
1. SHOULD: Configuration values SHOULD be extracted into constants (e.g., BASE_URL) rather than accessing process.env repeatedly throughout the component

## Policy Block

- SHOULD Configuration values SHOULD be extracted into constants (e.g., BASE_URL) rather than accessing process.env repeatedly throughout the component
