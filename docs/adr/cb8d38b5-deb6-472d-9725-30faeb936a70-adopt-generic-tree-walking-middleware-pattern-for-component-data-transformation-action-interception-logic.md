...
1. SHOULD: Action interception logic SHOULD distinguish between history-recording actions and transient UI state changes using action type filtering

## Policy Block

- SHOULD Action interception logic SHOULD distinguish between history-recording actions and transient UI state changes using action type filtering
