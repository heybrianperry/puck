# Standardize Message Queue Integration for Public API Event Distribution: Public Endpoints That
...
1. MUST: Public API endpoints that trigger asynchronous workflows MUST publish events to message queues rather than directly invoking internal services

## Policy Block

- MUST Public API endpoints that trigger asynchronous workflows MUST publish events to message queues rather than directly invoking internal services
