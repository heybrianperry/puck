...
1. MUST: Test scripts MUST use the standard Puppeteer API pattern: puppeteer.launch() for browser instances, browser.newPage() for page creation, and page.goto() for navigation

## Policy Block

- MUST Test scripts MUST use the standard Puppeteer API pattern: puppeteer.launch() for browser instances, browser.newPage() for page creation, and page.goto() for navigation
