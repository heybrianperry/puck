# Standardize Message Queue Integration for Public API Event Distribution: Provide Webhook Callbacks
...
1. MAY: APIs MAY provide webhook callbacks or polling endpoints for clients requiring synchronous confirmation of event processing

## Policy Block

- MAY APIs MAY provide webhook callbacks or polling endpoints for clients requiring synchronous confirmation of event processing
