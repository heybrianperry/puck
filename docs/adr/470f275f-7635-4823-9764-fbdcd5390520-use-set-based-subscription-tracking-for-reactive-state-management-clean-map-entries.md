...
1. MUST: Clean up Map entries using delete() operations when components unmount or items are removed to prevent memory leaks

## Policy Block

- MUST Clean up Map entries using delete() operations when components unmount or items are removed to prevent memory leaks
