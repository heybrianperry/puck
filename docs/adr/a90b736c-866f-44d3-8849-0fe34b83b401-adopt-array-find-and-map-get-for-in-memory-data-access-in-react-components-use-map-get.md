...
1. MUST: Use Map.get() for O(1) lookups when accessing cached data by identifier (e.g., component IDs, zone compounds)

## Policy Block

- MUST Use Map.get() for O(1) lookups when accessing cached data by identifier (e.g., component IDs, zone compounds)
