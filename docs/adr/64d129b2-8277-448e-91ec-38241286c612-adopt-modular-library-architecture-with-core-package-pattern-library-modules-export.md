# Adopt Modular Library Architecture with Core Package Pattern: Library Modules Export
...
1. MAY: Library modules MAY export configuration objects (e.g., default-viewports.ts) alongside their component implementations

## Policy Block

- MAY Library modules MAY export configuration objects (e.g., default-viewports.ts) alongside their component implementations
