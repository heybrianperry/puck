# Standardize External API Documentation with Embedded Analytics and Metadata: Applications Extend Base
...
1. MAY: Applications MAY extend base metadata configuration with application-specific properties as needed

## Policy Block

- MAY Applications MAY extend base metadata configuration with application-specific properties as needed
