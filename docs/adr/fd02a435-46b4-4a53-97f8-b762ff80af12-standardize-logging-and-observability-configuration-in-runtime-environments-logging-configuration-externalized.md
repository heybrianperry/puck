# Standardize Logging and Observability Configuration in Runtime Environments: Logging Configuration Externalized
...
1. MUST: Logging configuration MUST be externalized through environment variables or configuration files rather than hardcoded in application logic

## Policy Block

- MUST Logging configuration MUST be externalized through environment variables or configuration files rather than hardcoded in application logic
