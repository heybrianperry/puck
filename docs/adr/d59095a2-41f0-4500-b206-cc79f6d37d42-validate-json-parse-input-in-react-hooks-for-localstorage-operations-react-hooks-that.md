...
1. MUST: React hooks that parse localStorage data MUST provide fallback values when parsing fails

## Policy Block

- MUST React hooks that parse localStorage data MUST provide fallback values when parsing fails
