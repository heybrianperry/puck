# Standardize External API Documentation with Embedded Analytics and Metadata: Public Facing Applications
...
1. MUST_NOT: Public-facing applications MUST NOT hardcode API keys, tokens, or sensitive credentials in source code or configuration files

## Policy Block

- MUST_NOT Public-facing applications MUST NOT hardcode API keys, tokens, or sensitive credentials in source code or configuration files
