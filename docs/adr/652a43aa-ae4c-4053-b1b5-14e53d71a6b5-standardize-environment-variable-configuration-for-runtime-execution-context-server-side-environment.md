# Standardize Environment Variable Configuration for Runtime Execution Context: Server Side Environment
...
1. MUST: Server-side environment variables MUST NOT be exposed to client-side code unless explicitly marked as public/safe

## Policy Block

- MUST Server-side environment variables MUST NOT be exposed to client-side code unless explicitly marked as public/safe
