...
1. MAY: Combine Map and Array data structures when both keyed access and iteration are required

## Policy Block

- MAY Combine Map and Array data structures when both keyed access and iteration are required
