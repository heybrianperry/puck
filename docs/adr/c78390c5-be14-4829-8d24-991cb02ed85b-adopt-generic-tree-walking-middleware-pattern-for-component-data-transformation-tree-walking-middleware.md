...
1. SHOULD: Tree-walking middleware SHOULD process zones by iterating over zone keys and applying transformations to each zone's component array independently

## Policy Block

- SHOULD Tree-walking middleware SHOULD process zones by iterating over zone keys and applying transformations to each zone's component array independently
