# Adopt Catch-All Route Patterns for Dynamic Content Management Systems: Cms Integration Routes
...
1. MUST: CMS integration routes MUST be placed at the appropriate nesting level to capture all intended content paths (e.g., /puck/[...puckPath] or /api/puck/$)

## Policy Block

- MUST CMS integration routes MUST be placed at the appropriate nesting level to capture all intended content paths (e.g., /puck/[...puckPath] or /api/puck/$)
