...
1. MUST: E2E test scripts MUST use Puppeteer as the browser automation library for launching browsers and controlling pages

## Policy Block

- MUST E2E test scripts MUST use Puppeteer as the browser automation library for launching browsers and controlling pages
