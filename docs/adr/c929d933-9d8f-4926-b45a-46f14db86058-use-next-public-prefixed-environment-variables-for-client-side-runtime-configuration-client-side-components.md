...
1. MUST: Client-side components MUST access environment variables through process.env.NEXT_PUBLIC_* syntax

## Policy Block

- MUST Client-side components MUST access environment variables through process.env.NEXT_PUBLIC_* syntax
