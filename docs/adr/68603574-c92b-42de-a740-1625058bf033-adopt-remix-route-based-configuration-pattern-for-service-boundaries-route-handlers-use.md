# Adopt Remix Route-Based Configuration Pattern for Service Boundaries: Route Handlers Use
...
1. SHOULD: Route handlers SHOULD use loader and action functions to encapsulate service configuration and environment management

## Policy Block

- SHOULD Route handlers SHOULD use loader and action functions to encapsulate service configuration and environment management
