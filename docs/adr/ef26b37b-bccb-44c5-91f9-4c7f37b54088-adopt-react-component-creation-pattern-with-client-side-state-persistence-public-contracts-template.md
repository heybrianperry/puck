...
1. MUST: Public API contracts (Template) MUST be separated from internal implementation contracts (TemplateInternal) to enforce encapsulation

## Policy Block

- MUST Public API contracts (Template) MUST be separated from internal implementation contracts (TemplateInternal) to enforce encapsulation
