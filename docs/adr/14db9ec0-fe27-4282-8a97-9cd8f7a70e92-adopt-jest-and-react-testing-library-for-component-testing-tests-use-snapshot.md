# Adopt Jest and React Testing Library for Component Testing: Tests Use Snapshot
...
1. MAY: Tests MAY use snapshot testing for appropriate use cases such as serialized output validation

## Policy Block

- MAY Tests MAY use snapshot testing for appropriate use cases such as serialized output validation
