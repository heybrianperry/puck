...
1. SHOULD: NEXT_PUBLIC_ variables SHOULD be documented in project configuration files or README with their purpose and expected values

## Policy Block

- SHOULD NEXT_PUBLIC_ variables SHOULD be documented in project configuration files or README with their purpose and expected values
