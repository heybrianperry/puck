# Standardize Message Queue Integration for Public API Event Distribution: Event Payloads Published
...
1. MUST: Event payloads published to message queues MUST include sufficient context for downstream consumers to process independently

## Policy Block

- MUST Event payloads published to message queues MUST include sufficient context for downstream consumers to process independently
