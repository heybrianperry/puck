...
1. MUST: Cleanup operations MUST call .delete() on measurement caches and virtualizer registries when components unmount or identifiers change

## Policy Block

- MUST Cleanup operations MUST call .delete() on measurement caches and virtualizer registries when components unmount or identifiers change
