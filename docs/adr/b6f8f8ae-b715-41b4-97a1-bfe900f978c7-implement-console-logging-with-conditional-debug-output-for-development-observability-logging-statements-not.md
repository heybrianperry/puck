# Implement Console Logging with Conditional Debug Output for Development Observability: Logging Statements Not
...
1. MUST_NOT: Logging statements MUST NOT include sensitive information such as authentication tokens, API keys, passwords, personal identifiable information (PII), or any data marked as confidential

## Policy Block

- MUST_NOT Logging statements MUST NOT include sensitive information such as authentication tokens, API keys, passwords, personal identifiable information (PII), or any data marked as confidential
