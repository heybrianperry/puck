...
1. MUST: Client-side components that fetch data from external APIs MUST catch and log fetch errors using console.error

## Policy Block

- MUST Client-side components that fetch data from external APIs MUST catch and log fetch errors using console.error
