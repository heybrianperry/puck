# Adopt Snapshot Testing for Component and Reducer Unit Tests: Unit Tests React
...
1. MUST: Unit tests for React components that render complex UI structures MUST use snapshot testing to capture and verify rendering output

## Policy Block

- MUST Unit tests for React components that render complex UI structures MUST use snapshot testing to capture and verify rendering output
