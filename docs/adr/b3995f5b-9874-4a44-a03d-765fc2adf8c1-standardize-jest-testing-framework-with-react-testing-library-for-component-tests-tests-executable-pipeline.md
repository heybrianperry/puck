# Standardize Jest Testing Framework with React Testing Library for Component Tests: Tests Executable Pipeline
...
1. MUST: All tests MUST be executable in the CI/CD pipeline without manual intervention

## Policy Block

- MUST All tests MUST be executable in the CI/CD pipeline without manual intervention
