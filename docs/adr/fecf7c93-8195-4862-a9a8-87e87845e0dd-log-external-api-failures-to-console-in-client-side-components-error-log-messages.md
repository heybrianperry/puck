...
1. MUST: Error log messages MUST include contextual information identifying the failed operation and error details

## Policy Block

- MUST Error log messages MUST include contextual information identifying the failed operation and error details
