...
1. MUST: Use Map.get(key) for retrieving cached component measurements, references, and virtualizer handles indexed by component ID or zone compound identifier

## Policy Block

- MUST Use Map.get(key) for retrieving cached component measurements, references, and virtualizer handles indexed by component ID or zone compound identifier
