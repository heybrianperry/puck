...
1. MUST: All secrets and sensitive configuration values MUST be accessed exclusively through process.env rather than hardcoded in source files

## Policy Block

- MUST All secrets and sensitive configuration values MUST be accessed exclusively through process.env rather than hardcoded in source files
