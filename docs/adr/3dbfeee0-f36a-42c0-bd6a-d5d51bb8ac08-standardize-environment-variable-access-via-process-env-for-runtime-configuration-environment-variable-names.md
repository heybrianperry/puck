# Standardize Environment Variable Access via process.env for Runtime Configuration: Environment Variable Names
...
1. SHOULD: Environment variable names SHOULD follow a consistent naming convention (e.g., SCREAMING_SNAKE_CASE with application prefix)

## Policy Block

- SHOULD Environment variable names SHOULD follow a consistent naming convention (e.g., SCREAMING_SNAKE_CASE with application prefix)
