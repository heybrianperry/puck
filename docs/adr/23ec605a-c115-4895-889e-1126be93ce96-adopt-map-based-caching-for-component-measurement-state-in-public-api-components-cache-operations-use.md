...
1. MUST: Cache operations MUST use .get(), .set(), and .delete() methods for retrieval, storage, and cleanup of cached values

## Policy Block

- MUST Cache operations MUST use .get(), .set(), and .delete() methods for retrieval, storage, and cleanup of cached values
