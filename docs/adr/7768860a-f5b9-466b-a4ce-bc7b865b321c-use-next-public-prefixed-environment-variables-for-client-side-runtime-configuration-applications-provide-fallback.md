...
1. MAY: Applications MAY provide fallback values or default behavior when NEXT_PUBLIC_ variables are undefined

## Policy Block

- MAY Applications MAY provide fallback values or default behavior when NEXT_PUBLIC_ variables are undefined
