# Standardize Logging and Observability Configuration in Runtime Environments: Server Side Components
...
1. MUST: Server-side components MUST configure logging before initializing application logic to capture startup errors

## Policy Block

- MUST Server-side components MUST configure logging before initializing application logic to capture startup errors
