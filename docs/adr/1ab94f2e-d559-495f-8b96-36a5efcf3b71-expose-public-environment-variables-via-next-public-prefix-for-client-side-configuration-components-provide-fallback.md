...
1. MAY: Components MAY provide fallback behavior when optional public environment variables are undefined

## Policy Block

- MAY Components MAY provide fallback behavior when optional public environment variables are undefined
