# Adopt TypeScript Configuration Export Pattern for Public API Packages: Build Configurations Enable
...
1. SHOULD: Build configurations SHOULD enable tree-shaking optimizations through ESM module format and sideEffects declarations

## Policy Block

- SHOULD Build configurations SHOULD enable tree-shaking optimizations through ESM module format and sideEffects declarations
