...
1. MAY: Components MAY use createComponent factory pattern for consistent component instantiation with dependency injection

## Policy Block

- MAY Components MAY use createComponent factory pattern for consistent component instantiation with dependency injection
