...
1. MUST: Tree-walking functions MUST accept generic type parameters constrained to ComponentData, RootData, or UserData to ensure type safety across different data shapes

## Policy Block

- MUST Tree-walking functions MUST accept generic type parameters constrained to ComponentData, RootData, or UserData to ensure type safety across different data shapes
