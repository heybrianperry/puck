# Adopt Jest and React Testing Library for Component Testing: Tests Use Jest
...
1. SHOULD: Tests SHOULD use Jest mocking capabilities (jest.fn(), jest.mock()) for creating test doubles and isolating units under test

## Policy Block

- SHOULD Tests SHOULD use Jest mocking capabilities (jest.fn(), jest.mock()) for creating test doubles and isolating units under test
