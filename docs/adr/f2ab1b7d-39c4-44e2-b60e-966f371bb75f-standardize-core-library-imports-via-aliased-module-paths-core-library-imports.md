...
1. SHOULD: Core library imports SHOULD be organized by subdomain (types, lib, components) using subpath aliases (e.g., @/core/types, @/core/lib)

## Policy Block

- SHOULD Core library imports SHOULD be organized by subdomain (types, lib, components) using subpath aliases (e.g., @/core/types, @/core/lib)
