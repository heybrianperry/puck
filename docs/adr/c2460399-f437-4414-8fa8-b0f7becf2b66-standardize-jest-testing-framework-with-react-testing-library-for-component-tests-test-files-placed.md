# Standardize Jest Testing Framework with React Testing Library for Component Tests: Test Files Placed
...
1. MUST: Test files MUST be placed in __tests__ directories adjacent to the code they test

## Policy Block

- MUST Test files MUST be placed in __tests__ directories adjacent to the code they test
