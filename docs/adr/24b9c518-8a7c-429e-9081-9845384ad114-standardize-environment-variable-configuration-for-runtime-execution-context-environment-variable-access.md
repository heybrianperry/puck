# Standardize Environment Variable Configuration for Runtime Execution Context: Environment Variable Access
...
1. SHOULD_NOT: Environment variable access SHOULD NOT be scattered throughout the codebase; centralized configuration modules are preferred

## Policy Block

- SHOULD_NOT Environment variable access SHOULD NOT be scattered throughout the codebase; centralized configuration modules are preferred
