...
1. SHOULD: Environment-specific variables SHOULD follow the NEXT_PUBLIC_ prefix convention for client-side accessibility

## Policy Block

- SHOULD Environment-specific variables SHOULD follow the NEXT_PUBLIC_ prefix convention for client-side accessibility
