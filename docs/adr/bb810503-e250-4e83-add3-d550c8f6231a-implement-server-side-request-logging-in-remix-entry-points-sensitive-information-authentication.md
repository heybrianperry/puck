# Implement Server-Side Request Logging in Remix Entry Points: Sensitive Information Authentication
...
1. SHOULD: Sensitive information (authentication tokens, passwords, PII) SHOULD be filtered from logs before emission

## Policy Block

- SHOULD Sensitive information (authentication tokens, passwords, PII) SHOULD be filtered from logs before emission
