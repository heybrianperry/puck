...
1. MUST: Client-side components accessing environment variables MUST use process.env.NEXT_PUBLIC_* syntax

## Policy Block

- MUST Client-side components accessing environment variables MUST use process.env.NEXT_PUBLIC_* syntax
