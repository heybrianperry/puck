...
1. MUST_NOT: Avoid manual iteration loops (for/while) when Array.find() or Map.get() can express the query intent more clearly

## Policy Block

- MUST_NOT Avoid manual iteration loops (for/while) when Array.find() or Map.get() can express the query intent more clearly
