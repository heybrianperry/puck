...
1. MUST: Configuration MUST use VERCEL_GIT_COMMIT_REF to determine the active Git branch context

## Policy Block

- MUST Configuration MUST use VERCEL_GIT_COMMIT_REF to determine the active Git branch context
