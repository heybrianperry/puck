...
1. MUST: Components that expose public APIs MUST define separate internal and public contract types to enforce interface boundaries

## Policy Block

- MUST Components that expose public APIs MUST define separate internal and public contract types to enforce interface boundaries
