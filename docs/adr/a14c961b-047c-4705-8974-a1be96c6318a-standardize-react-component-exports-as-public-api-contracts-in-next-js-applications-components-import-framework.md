...
1. MUST: Components MUST import framework dependencies (react, next/*) and shared utilities from @/core before local imports

## Policy Block

- MUST Components MUST import framework dependencies (react, next/*) and shared utilities from @/core before local imports
