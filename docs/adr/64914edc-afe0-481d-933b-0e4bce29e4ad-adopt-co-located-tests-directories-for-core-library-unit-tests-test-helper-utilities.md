# Adopt Co-located __tests__ Directories for Core Library Unit Tests: Test Helper Utilities
...
1. SHOULD: Test helper utilities shared across multiple test files SHOULD be placed in __helpers__ subdirectories within __tests__

## Policy Block

- SHOULD Test helper utilities shared across multiple test files SHOULD be placed in __helpers__ subdirectories within __tests__
