...
1. MUST_NOT: Components MUST NOT use relative paths (../, ../../) to import from core libraries when a path alias is available

## Policy Block

- MUST_NOT Components MUST NOT use relative paths (../, ../../) to import from core libraries when a path alias is available
