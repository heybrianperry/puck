# Adopt Catch-All Route Patterns for Dynamic Content Management Systems: Applications Implement Multiple
...
1. MAY: Applications MAY implement multiple catch-all routes for different CMS instances or content domains, provided they do not overlap in path space

## Policy Block

- MAY Applications MAY implement multiple catch-all routes for different CMS instances or content domains, provided they do not overlap in path space
