...
1. MUST: Array-based queries using .find() MUST be encapsulated within React hooks (useCallback, useMemo) to prevent unnecessary recomputation

## Policy Block

- MUST Array-based queries using .find() MUST be encapsulated within React hooks (useCallback, useMemo) to prevent unnecessary recomputation
