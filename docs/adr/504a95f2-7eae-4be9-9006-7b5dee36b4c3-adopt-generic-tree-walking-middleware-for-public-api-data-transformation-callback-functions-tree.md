...
1. MUST: Callback functions in tree-walking APIs MUST support returning null or void to indicate no transformation, with the original value preserved

## Policy Block

- MUST Callback functions in tree-walking APIs MUST support returning null or void to indicate no transformation, with the original value preserved
