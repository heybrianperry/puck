...
1. MUST: Element inspection within iframes MUST calculate frame transformations including position (x, y) and scale (scaleX, scaleY)

## Policy Block

- MUST Element inspection within iframes MUST calculate frame transformations including position (x, y) and scale (scaleX, scaleY)
