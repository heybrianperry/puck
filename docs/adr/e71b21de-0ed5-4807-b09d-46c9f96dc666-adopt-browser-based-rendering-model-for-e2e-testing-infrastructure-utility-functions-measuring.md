# Adopt Browser-Based Rendering Model for E2E Testing Infrastructure: Utility Functions Measuring
...
1. SHOULD: Utility functions for measuring UI elements SHOULD be centralized in dedicated modules (e.g., get-box.mjs) to ensure consistency

## Policy Block

- SHOULD Utility functions for measuring UI elements SHOULD be centralized in dedicated modules (e.g., get-box.mjs) to ensure consistency
