...
1. MUST: Public configuration values exposed to the browser MUST use the NEXT_PUBLIC_ prefix convention

## Policy Block

- MUST Public configuration values exposed to the browser MUST use the NEXT_PUBLIC_ prefix convention
