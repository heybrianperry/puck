# Adopt Console-Based Logging for Development and Debugging: Applications Wrap Console
...
1. MAY: Applications MAY wrap console methods with custom logging utilities for enhanced formatting or filtering while maintaining console as the underlying transport

## Policy Block

- MAY Applications MAY wrap console methods with custom logging utilities for enhanced formatting or filtering while maintaining console as the underlying transport
