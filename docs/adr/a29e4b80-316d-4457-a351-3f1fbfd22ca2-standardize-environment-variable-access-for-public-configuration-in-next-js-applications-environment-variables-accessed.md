...
1. MUST: Environment variables MUST be accessed via process.env with explicit property access (e.g., process.env.NEXT_PUBLIC_BASE_URL)

## Policy Block

- MUST Environment variables MUST be accessed via process.env with explicit property access (e.g., process.env.NEXT_PUBLIC_BASE_URL)
