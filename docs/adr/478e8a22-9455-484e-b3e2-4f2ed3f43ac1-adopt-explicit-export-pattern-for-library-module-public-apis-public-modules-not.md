# Adopt Explicit Export Pattern for Library Module Public APIs: Public Modules Not
...
1. MUST_NOT: Public API modules MUST NOT export internal helper functions, types, or constants unless explicitly intended for public use

## Policy Block

- MUST_NOT Public API modules MUST NOT export internal helper functions, types, or constants unless explicitly intended for public use
