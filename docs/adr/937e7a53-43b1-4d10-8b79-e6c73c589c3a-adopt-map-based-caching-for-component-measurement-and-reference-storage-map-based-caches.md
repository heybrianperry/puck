...
1. SHOULD: Map-based caches SHOULD be stored in refs (useRef) to prevent re-renders when cache contents change

## Policy Block

- SHOULD Map-based caches SHOULD be stored in refs (useRef) to prevent re-renders when cache contents change
