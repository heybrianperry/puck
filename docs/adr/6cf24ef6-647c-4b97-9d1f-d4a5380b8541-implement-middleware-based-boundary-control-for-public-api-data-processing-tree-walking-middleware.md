# Implement Middleware-Based Boundary Control for Public API Data Processing: Tree Walking Middleware
...
1. SHOULD: Tree-walking middleware SHOULD implement visitor patterns to allow extensible transformation operations on nested structures

## Policy Block

- SHOULD Tree-walking middleware SHOULD implement visitor patterns to allow extensible transformation operations on nested structures
