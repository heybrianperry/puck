# Adopt Jest and React Testing Library for Component Testing: Test Suites Use
...
1. MUST: Test suites MUST use Jest as the test runner and assertion framework

## Policy Block

- MUST Test suites MUST use Jest as the test runner and assertion framework
