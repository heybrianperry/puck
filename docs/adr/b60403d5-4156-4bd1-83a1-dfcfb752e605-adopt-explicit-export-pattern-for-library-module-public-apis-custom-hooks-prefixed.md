# Adopt Explicit Export Pattern for Library Module Public APIs: Custom Hooks Prefixed
...
1. SHOULD: Custom hooks SHOULD be prefixed with 'use-' and exported from dedicated module files

## Policy Block

- SHOULD Custom hooks SHOULD be prefixed with 'use-' and exported from dedicated module files
