...
1. SHOULD: Store measurement caches and component references in Map structures accessed via Map.get() and Map.set()

## Policy Block

- SHOULD Store measurement caches and component references in Map structures accessed via Map.get() and Map.set()
