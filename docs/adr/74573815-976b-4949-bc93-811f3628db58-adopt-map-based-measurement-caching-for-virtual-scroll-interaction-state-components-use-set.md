...
1. MAY: Components MAY use Set data structures for tracking pinned indexes or other interaction state alongside measurement caches

## Policy Block

- MAY Components MAY use Set data structures for tracking pinned indexes or other interaction state alongside measurement caches
