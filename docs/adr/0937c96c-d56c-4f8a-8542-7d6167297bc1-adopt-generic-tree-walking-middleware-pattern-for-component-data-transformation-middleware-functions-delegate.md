...
1. MUST: Middleware functions MUST delegate field-level traversal to specialized utilities (e.g., mapFields) to maintain separation of concerns between tree navigation and field transformation

## Policy Block

- MUST Middleware functions MUST delegate field-level traversal to specialized utilities (e.g., mapFields) to maintain separation of concerns between tree navigation and field transformation
