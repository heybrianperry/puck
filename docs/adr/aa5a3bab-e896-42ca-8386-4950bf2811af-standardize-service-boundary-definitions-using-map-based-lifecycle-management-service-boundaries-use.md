...
1. MUST: Service boundaries MUST use Map-based data structures for component lifecycle management when tracking multiple instances with unique identifiers

## Policy Block

- MUST Service boundaries MUST use Map-based data structures for component lifecycle management when tracking multiple instances with unique identifiers
