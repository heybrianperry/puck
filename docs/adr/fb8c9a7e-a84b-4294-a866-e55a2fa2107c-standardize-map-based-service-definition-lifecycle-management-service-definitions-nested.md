...
1. MAY: Service definitions MAY be nested within current properties of ref objects for imperative access patterns

## Policy Block

- MAY Service definitions MAY be nested within current properties of ref objects for imperative access patterns
