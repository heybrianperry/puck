# Standardize Jest Testing Framework with React Testing Library for Component Tests: Tests Use Snapshot
...
1. MAY: Tests MAY use snapshot testing for stable UI components, but should not rely solely on snapshots

## Policy Block

- MAY Tests MAY use snapshot testing for stable UI components, but should not rely solely on snapshots
