...
1. SHOULD: Store frequently accessed cached data (measurements, refs, handles) in Map structures rather than arrays when access is by key

## Policy Block

- SHOULD Store frequently accessed cached data (measurements, refs, handles) in Map structures rather than arrays when access is by key
