# Implement Structured Server-Side Logging with Cache Layer Integration in Remix Applications: Error Conditions During
...
1. SHOULD: Error conditions during server-side rendering SHOULD be logged with full stack traces and request context

## Policy Block

- SHOULD Error conditions during server-side rendering SHOULD be logged with full stack traces and request context
