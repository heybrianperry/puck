# Adopt Co-located __tests__ Directories for Core Library Unit Tests: Test File Names
...
1. MUST: Test file names MUST clearly indicate the module under test (e.g., move-component.spec.tsx tests move-component functionality)

## Policy Block

- MUST Test file names MUST clearly indicate the module under test (e.g., move-component.spec.tsx tests move-component functionality)
