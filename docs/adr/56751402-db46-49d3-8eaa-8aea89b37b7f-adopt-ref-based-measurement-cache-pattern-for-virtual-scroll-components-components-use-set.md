...
1. MAY: Components MAY use Set data structures (nextPinnedIndexes) for index tracking when order-independent membership testing is required

## Policy Block

- MAY Components MAY use Set data structures (nextPinnedIndexes) for index tracking when order-independent membership testing is required
