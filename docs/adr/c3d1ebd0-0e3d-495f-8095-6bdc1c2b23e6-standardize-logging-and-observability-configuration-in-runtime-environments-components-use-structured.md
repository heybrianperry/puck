# Standardize Logging and Observability Configuration in Runtime Environments: Components Use Structured
...
1. SHOULD: Components SHOULD use structured logging formats (JSON, key-value pairs) to enable automated log parsing and analysis

## Policy Block

- SHOULD Components SHOULD use structured logging formats (JSON, key-value pairs) to enable automated log parsing and analysis
