...
1. SHOULD: Tests for field types with multiple interaction modes SHOULD include separate test cases for each mode (e.g., standard vs contentEditable)

## Policy Block

- SHOULD Tests for field types with multiple interaction modes SHOULD include separate test cases for each mode (e.g., standard vs contentEditable)
