...
1. MUST: Component test files MUST use the describe/it structure to organize test suites and individual test cases

## Policy Block

- MUST Component test files MUST use the describe/it structure to organize test suites and individual test cases
