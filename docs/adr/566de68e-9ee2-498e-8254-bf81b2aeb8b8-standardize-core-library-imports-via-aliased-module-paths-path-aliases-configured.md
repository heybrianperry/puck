...
1. MUST: Path aliases MUST be configured consistently across all build tools (TypeScript, bundlers, test runners) within each application

## Policy Block

- MUST Path aliases MUST be configured consistently across all build tools (TypeScript, bundlers, test runners) within each application
