...
1. MUST: Use Map.set() and Map.delete() for managing lifecycle of cached entries in performance-sensitive contexts

## Policy Block

- MUST Use Map.set() and Map.delete() for managing lifecycle of cached entries in performance-sensitive contexts
