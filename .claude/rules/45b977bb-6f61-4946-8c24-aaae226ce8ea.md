<rule_activation id="45b977bb-6f61-4946-8c24-aaae226ce8ea" title="Enforce Input Validation and Boundary Checking for Configuration Parameters: Numeric Configuration Parameters" applies_to="**/*">
...
- **R-CFG-001** MUST: Numeric configuration parameters MUST have defined minimum and maximum bounds that are enforced at runtime.
...
<enforcement>
Claude Code MUST verify all configuration parameter handling against these rules. Violations detected by static analysis, code review, or testing MUST be resolved before code is committed. Exceptions require explicit documentation and tech lead approval.
</enforcement>